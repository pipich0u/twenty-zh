...
import { sortFieldsByRelevanceForWidget } from '@/page-layout/widgets/record-table/utils/sortFieldsByRelevanceForWidget';
...
describe('sortFieldsByRelevanceForWidget', () => {
  it('returns -1 when fieldA is the label identifier field', () => {
    const comparator = sortFieldsByRelevanceForWidget(
