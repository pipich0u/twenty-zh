import { computeLastRecordTableColumnWidth } from '../computeLastRecordTableColumnWidth';
...
describe('computeLastRecordTableColumnWidth', () => {
  ...
  it('excludes drag-and-drop and checkbox widths from the calculation when areLeftColumnsHidden is true', () => {
    const recordFields = [{ size: 100 }, { size: 100 }];
