...
export type ApplicationRegistrationSourceType =
  | 'NPM'
  | 'TARBALL'
  | 'LOCAL'
  | 'OAUTH_ONLY';
...
export type MessageChannelContactAutoCreationPolicy =
  | 'SENT_AND_RECEIVED'
  | 'SENT'
  | 'NONE';
...
export type MessageChannelPendingGroupEmailsAction =
...
export type ConfigVariablesGroup =
  | 'SERVER_CONFIG'
  | 'RATE_LIMITING'
  | 'STORAGE_CONFIG'
  | 'GOOGLE_AUTH'
...
export type QueueMetricsTimeRange =
  | 'SevenDays'
  | 'OneDay'
  | 'TwelveHours'
  | 'FourHours'
...
export interface IndexGenqlSelection {
  ...
  objectMetadata?: IndexObjectMetadataConnectionGenqlSelection & {
    __args: {
  ...
  indexFieldMetadatas?: IndexIndexFieldMetadatasConnectionGenqlSelection & {
    __args: {
      /** Limit or page results. */
      paging: CursorPaging;
      /** Specify to filter the records returned. */
...
export interface ObjectFilter {
  and?: ObjectFilter[] | null;
  or?: ObjectFilter[] | null;
  id?: UUIDFilterComparison | null;
  isCustom?: BooleanFieldComparison | null;
  isRemote?: BooleanFieldComparison | null;
  isActive?: BooleanFieldComparison | null;
  isSystem?: BooleanFieldComparison | null;
  isUIReadOnly?: BooleanFieldComparison | null;
  isSearchable?: BooleanFieldComparison | null;
}

export interface UUIDFilterComparison {
  is?: Scalars['Boolean'] | null;
  isNot?: Scalars['Boolean'] | null;
  eq?: Scalars['UUID'] | null;
  neq?: Scalars['UUID'] | null;
  gt?: Scalars['UUID'] | null;
  gte?: Scalars['UUID'] | null;
  lt?: Scalars['UUID'] | null;
  lte?: Scalars['UUID'] | null;
  like?: Scalars['UUID'] | null;
  notLike?: Scalars['UUID'] | null;
  iLike?: Scalars['UUID'] | null;
  notILike?: Scalars['UUID'] | null;
  in?: Scalars['UUID'][] | null;
  notIn?: Scalars['UUID'][] | null;
}
...
export interface IndexFieldFilter {
  and?: IndexFieldFilter[] | null;
  or?: IndexFieldFilter[] | null;
  id?: UUIDFilterComparison | null;
  fieldMetadataId?: UUIDFilterComparison | null;
}
...
export interface ObjectGenqlSelection {
  ...
  fields?: ObjectFieldsConnectionGenqlSelection & {
    __args: {
      /** Limit or page results. */
      paging: CursorPaging;
      /** Specify to filter the records returned. */
  ...
  indexMetadatas?: ObjectIndexMetadatasConnectionGenqlSelection & {
    __args: {
      /** Limit or page results. */
      paging: CursorPaging;
      /** Specify to filter the records returned. */
...
export interface QueryGenqlSelection {
  ...
  navigationMenuItem?: NavigationMenuItemGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  getPageLayoutWidgets?: PageLayoutWidgetGenqlSelection & {
    __args: { pageLayoutTabId: Scalars['String'] };
  };
  getPageLayoutWidget?: PageLayoutWidgetGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  getPageLayoutTabs?: PageLayoutTabGenqlSelection & {
    __args: { pageLayoutId: Scalars['String'] };
  };
  getPageLayoutTab?: PageLayoutTabGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  getPageLayouts?: PageLayoutGenqlSelection & {
    __args?: {
      objectMetadataId?: Scalars['String'] | null;
      pageLayoutType?: PageLayoutType | null;
    };
  };
  getPageLayout?: PageLayoutGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  getViews?: ViewGenqlSelection & {
    __args?: {
      objectMetadataId?: Scalars['String'] | null;
  ...
  getViewSorts?: ViewSortGenqlSelection & {
    __args?: { viewId?: Scalars['String'] | null };
  };
  getViewSort?: ViewSortGenqlSelection & { __args: { id: Scalars['String'] } };
  getViewFieldGroups?: ViewFieldGroupGenqlSelection & {
    __args: { viewId: Scalars['String'] };
  };
  getViewFieldGroup?: ViewFieldGroupGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  findOneLogicFunction?: LogicFunctionGenqlSelection & {
    __args: { input: LogicFunctionIdInput };
  };
  ...
  commandMenuItem?: CommandMenuItemGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  ...
  getViewFields?: ViewFieldGenqlSelection & {
    __args: { viewId: Scalars['String'] };
  };
  getViewField?: ViewFieldGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  ...
  billingPortalSession?: BillingSessionGenqlSelection & {
    __args?: { returnUrlPath?: Scalars['String'] | null };
  };
  ...
  enterpriseCheckoutSession?:
    | { __args: { billingInterval?: Scalars['String'] | null } }
    | boolean
    | number;
  ...
  getViewGroups?: ViewGroupGenqlSelection & {
    __args?: { viewId?: Scalars['String'] | null };
  };
  getViewGroup?: ViewGroupGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  getViewFilters?: ViewFilterGenqlSelection & {
    __args?: { viewId?: Scalars['String'] | null };
  };
  getViewFilter?: ViewFilterGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  getViewFilterGroups?: ViewFilterGroupGenqlSelection & {
    __args?: { viewId?: Scalars['String'] | null };
  };
  getViewFilterGroup?: ViewFilterGroupGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  currentUser?: UserGenqlSelection;
  currentWorkspace?: WorkspaceGenqlSelection;
  getPublicWorkspaceDataByDomain?: PublicWorkspaceDataGenqlSelection & {
    __args?: { origin?: Scalars['String'] | null };
  };
  findApplicationRegistrationByClientId?: PublicApplicationRegistrationGenqlSelection & {
    __args: { clientId: Scalars['String'] };
  };
  findApplicationRegistrationByUniversalIdentifier?: ApplicationRegistrationGenqlSelection & {
    __args: { universalIdentifier: Scalars['String'] };
  };
  findManyApplicationRegistrations?: ApplicationRegistrationGenqlSelection;
  findOneApplicationRegistration?: ApplicationRegistrationGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  findApplicationRegistrationStats?: ApplicationRegistrationStatsGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  findApplicationRegistrationVariables?: ApplicationRegistrationVariableGenqlSelection & {
    __args: { applicationRegistrationId: Scalars['String'] };
  };
  applicationRegistrationTarballUrl?: { __args: { id: Scalars['String'] } };
  checkUserExists?: CheckUserExistGenqlSelection & {
    __args: {
      email: Scalars['String'];
      captchaToken?: Scalars['String'] | null;
    };
  };
  checkWorkspaceInviteHashIsValid?: WorkspaceInviteHashValidGenqlSelection & {
    __args: { inviteHash: Scalars['String'] };
  };
  findWorkspaceFromInviteHash?: WorkspaceGenqlSelection & {
    __args: { inviteHash: Scalars['String'] };
  };
  validatePasswordResetToken?: ValidatePasswordResetTokenGenqlSelection & {
    __args: { passwordResetToken: Scalars['String'] };
  };
  getSSOIdentityProviders?: FindAvailableSSOIDPGenqlSelection;
  myMessageFolders?: MessageFolderGenqlSelection & {
    __args?: { messageChannelId?: Scalars['UUID'] | null };
  };
  myMessageChannels?: MessageChannelGenqlSelection & {
    __args?: { connectedAccountId?: Scalars['UUID'] | null };
  };
  myConnectedAccounts?: ConnectedAccountDTOGenqlSelection;
  connectedAccounts?: ConnectedAccountDTOGenqlSelection;
  myCalendarChannels?: CalendarChannelGenqlSelection & {
    __args?: { connectedAccountId?: Scalars['UUID'] | null };
  };
  webhooks?: WebhookGenqlSelection;
  webhook?: WebhookGenqlSelection & { __args: { id: Scalars['UUID'] } };
  minimalMetadata?: MinimalMetadataGenqlSelection;
  chatThread?: AgentChatThreadGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  chatMessages?: AgentMessageGenqlSelection & {
    __args: { threadId: Scalars['UUID'] };
  };
  getAISystemPromptPreview?: AISystemPromptPreviewGenqlSelection;
  skills?: SkillGenqlSelection;
  skill?: SkillGenqlSelection & { __args: { id: Scalars['UUID'] } };
  chatThreads?: AgentChatThreadConnectionGenqlSelection & {
    __args: {
      /** Limit or page results. */
      paging: CursorPaging;
      /** Specify to filter the records returned. */
  ...
  agentTurns?: AgentTurnGenqlSelection & {
    __args: { agentId: Scalars['UUID'] };
  };
  eventLogs?: EventLogQueryResultGenqlSelection & {
    __args: { input: EventLogQueryInput };
  };
  pieChartData?: PieChartDataGenqlSelection & {
    __args: { input: PieChartDataInput };
  };
  lineChartData?: LineChartDataGenqlSelection & {
    __args: { input: LineChartDataInput };
  };
  barChartData?: BarChartDataGenqlSelection & {
    __args: { input: BarChartDataInput };
  };
  getConnectedImapSmtpCaldavAccount?: ConnectedImapSmtpCaldavAccountGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  getAutoCompleteAddress?: AutocompleteResultGenqlSelection & {
    __args: {
      address: Scalars['String'];
      token: Scalars['String'];
      country?: Scalars['String'] | null;
      isFieldCity?: Scalars['Boolean'] | null;
    };
  };
  getAddressDetails?: PlaceDetailsResultGenqlSelection & {
    __args: { placeId: Scalars['String']; token: Scalars['String'] };
  };
  getConfigVariablesGrouped?: ConfigVariablesGenqlSelection;
  getSystemHealthStatus?: SystemHealthGenqlSelection;
  getIndicatorHealthStatus?: AdminPanelHealthServiceDataGenqlSelection & {
    __args: { indicatorId: HealthIndicatorId };
  };
  getQueueMetrics?: QueueMetricsDataGenqlSelection & {
    __args: {
      queueName: Scalars['String'];
      timeRange?: QueueMetricsTimeRange | null;
    };
  };
  ...
  getDatabaseConfigVariable?: ConfigVariableGenqlSelection & {
    __args: { key: Scalars['String'] };
  };
  getQueueJobs?: QueueJobsResponseGenqlSelection & {
    __args: {
      queueName: Scalars['String'];
      state: JobState;
  ...
  getModelsDevSuggestions?: ModelsDevModelSuggestionGenqlSelection & {
    __args: { providerType: Scalars['String'] };
  };
  ...
  findOneMarketplaceApp?: MarketplaceAppGenqlSelection & {
    __args: { universalIdentifier: Scalars['String'] };
  };
  findManyApplications?: ApplicationGenqlSelection;
  findOneApplication?: ApplicationGenqlSelection & {
    __args?: {
      id?: Scalars['UUID'] | null;
      universalIdentifier?: Scalars['UUID'] | null;
    };
  };
  getUsageAnalytics?: UsageAnalyticsGenqlSelection & {
    __args?: { input?: UsageAnalyticsInput | null };
  };
  __typename?: boolean | number;
  __scalar?: boolean | number;
}
...
export interface AgentChatThreadFilter {
  and?: AgentChatThreadFilter[] | null;
  or?: AgentChatThreadFilter[] | null;
  id?: UUIDFilterComparison | null;
...
export interface AgentChatThreadSort {
...
export interface EventLogQueryInput {
  table: EventLogTable;
  filters?: EventLogFiltersInput | null;
  first?: Scalars['Int'] | null;
  after?: Scalars['String'] | null;
}

export interface EventLogFiltersInput {
  eventType?: Scalars['String'] | null;
  userWorkspaceId?: Scalars['String'] | null;
  dateRange?: EventLogDateRangeInput | null;
  recordId?: Scalars['String'] | null;
  objectMetadataId?: Scalars['String'] | null;
}

export interface EventLogDateRangeInput {
  start?: Scalars['DateTime'] | null;
  end?: Scalars['DateTime'] | null;
}

export interface PieChartDataInput {
  objectMetadataId: Scalars['UUID'];
  configuration: Scalars['JSON'];
}

export interface LineChartDataInput {
  objectMetadataId: Scalars['UUID'];
  configuration: Scalars['JSON'];
}

export interface BarChartDataInput {
  objectMetadataId: Scalars['UUID'];
  configuration: Scalars['JSON'];
}
...
export interface MutationGenqlSelection {
  ...
  removeQueryFromEventStream?: {
    __args: { input: RemoveQueryFromEventStreamInput };
  };
  createPageLayoutWidget?: PageLayoutWidgetGenqlSelection & {
    __args: { input: CreatePageLayoutWidgetInput };
  };
  updatePageLayoutWidget?: PageLayoutWidgetGenqlSelection & {
    __args: { id: Scalars['String']; input: UpdatePageLayoutWidgetInput };
  };
  destroyPageLayoutWidget?: { __args: { id: Scalars['String'] } };
  createPageLayoutTab?: PageLayoutTabGenqlSelection & {
    __args: { input: CreatePageLayoutTabInput };
  };
  updatePageLayoutTab?: PageLayoutTabGenqlSelection & {
    __args: { id: Scalars['String']; input: UpdatePageLayoutTabInput };
  };
  destroyPageLayoutTab?: { __args: { id: Scalars['String'] } };
  createPageLayout?: PageLayoutGenqlSelection & {
    __args: { input: CreatePageLayoutInput };
  };
  updatePageLayout?: PageLayoutGenqlSelection & {
    __args: { id: Scalars['String']; input: UpdatePageLayoutInput };
  };
  destroyPageLayout?: { __args: { id: Scalars['String'] } };
  updatePageLayoutWithTabsAndWidgets?: PageLayoutGenqlSelection & {
    __args: { id: Scalars['String']; input: UpdatePageLayoutWithTabsInput };
  };
  createView?: ViewGenqlSelection & { __args: { input: CreateViewInput } };
  updateView?: ViewGenqlSelection & {
    __args: { id: Scalars['String']; input: UpdateViewInput };
  };
  deleteView?: { __args: { id: Scalars['String'] } };
  destroyView?: { __args: { id: Scalars['String'] } };
  createViewSort?: ViewSortGenqlSelection & {
    __args: { input: CreateViewSortInput };
  };
  updateViewSort?: ViewSortGenqlSelection & {
    __args: { input: UpdateViewSortInput };
  };
  deleteViewSort?: { __args: { input: DeleteViewSortInput } };
  destroyViewSort?: { __args: { input: DestroyViewSortInput } };
  updateViewFieldGroup?: ViewFieldGroupGenqlSelection & {
    __args: { input: UpdateViewFieldGroupInput };
  };
  createViewFieldGroup?: ViewFieldGroupGenqlSelection & {
    __args: { input: CreateViewFieldGroupInput };
  };
  createManyViewFieldGroups?: ViewFieldGroupGenqlSelection & {
    __args: { inputs: CreateViewFieldGroupInput[] };
  };
  deleteViewFieldGroup?: ViewFieldGroupGenqlSelection & {
    __args: { input: DeleteViewFieldGroupInput };
  };
  destroyViewFieldGroup?: ViewFieldGroupGenqlSelection & {
    __args: { input: DestroyViewFieldGroupInput };
  };
  upsertFieldsWidget?: ViewGenqlSelection & {
    __args: { input: UpsertFieldsWidgetInput };
  };
  deleteOneLogicFunction?: LogicFunctionGenqlSelection & {
    __args: { input: LogicFunctionIdInput };
  };
  createOneLogicFunction?: LogicFunctionGenqlSelection & {
    __args: { input: CreateLogicFunctionFromSourceInput };
  };
  executeOneLogicFunction?: LogicFunctionExecutionResultGenqlSelection & {
    __args: { input: ExecuteOneLogicFunctionInput };
  };
  updateOneLogicFunction?: {
    __args: { input: UpdateLogicFunctionFromSourceInput };
  };
  createObjectEvent?: AnalyticsGenqlSelection & {
    __args: {
      event: Scalars['String'];
  ...
  trackAnalytics?: AnalyticsGenqlSelection & {
    __args: {
      type: AnalyticsType;
  ...
  createOneObject?: ObjectGenqlSelection & {
    __args: { input: CreateOneObjectInput };
  };
  deleteOneObject?: ObjectGenqlSelection & {
    __args: { input: DeleteOneObjectInput };
  };
  updateOneObject?: ObjectGenqlSelection & {
    __args: { input: UpdateOneObjectInput };
  };
  updateCoreViewField?: CoreViewFieldGenqlSelection & {
    __args: { input: UpdateViewFieldInput };
  };
  createCoreViewField?: CoreViewFieldGenqlSelection & {
    __args: { input: CreateViewFieldInput };
  };
  createManyCoreViewFields?: CoreViewFieldGenqlSelection & {
    __args: { inputs: CreateViewFieldInput[] };
  };
  deleteCoreViewField?: CoreViewFieldGenqlSelection & {
    __args: { input: DeleteViewFieldInput };
  };
  destroyCoreViewField?: CoreViewFieldGenqlSelection & {
    __args: { input: DestroyViewFieldInput };
  };
  createCoreView?: CoreViewGenqlSelection & {
    __args: { input: CreateViewInput };
  };
  updateCoreView?: CoreViewGenqlSelection & {
    __args: { id: Scalars['String']; input: UpdateViewInput };
  };
  deleteCoreView?: { __args: { id: Scalars['String'] } };
  destroyCoreView?: { __args: { id: Scalars['String'] } };
  createCoreViewSort?: CoreViewSortGenqlSelection & {
    __args: { input: CreateViewSortInput };
  };
  updateCoreViewSort?: CoreViewSortGenqlSelection & {
    __args: { input: UpdateViewSortInput };
  };
  deleteCoreViewSort?: { __args: { input: DeleteViewSortInput } };
  destroyCoreViewSort?: { __args: { input: DestroyViewSortInput } };
  updateCoreViewFieldGroup?: CoreViewFieldGroupGenqlSelection & {
    __args: { input: UpdateViewFieldGroupInput };
  };
  createCoreViewFieldGroup?: CoreViewFieldGroupGenqlSelection & {
    __args: { input: CreateViewFieldGroupInput };
  };
  createManyCoreViewFieldGroups?: CoreViewFieldGroupGenqlSelection & {
    __args: { inputs: CreateViewFieldGroupInput[] };
  };
  deleteCoreViewFieldGroup?: CoreViewFieldGroupGenqlSelection & {
    __args: { input: DeleteViewFieldGroupInput };
  };
  destroyCoreViewFieldGroup?: CoreViewFieldGroupGenqlSelection & {
    __args: { input: DestroyViewFieldGroupInput };
  };
  upsertFieldsWidget?: CoreViewGenqlSelection & {
    __args: { input: UpsertFieldsWidgetInput };
  };
  createCommandMenuItem?: CommandMenuItemGenqlSelection & {
    __args: { input: CreateCommandMenuItemInput };
  };
  updateCommandMenuItem?: CommandMenuItemGenqlSelection & {
    __args: { input: UpdateCommandMenuItemInput };
  };
  deleteCommandMenuItem?: CommandMenuItemGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  createFrontComponent?: FrontComponentGenqlSelection & {
    __args: { input: CreateFrontComponentInput };
  };
  updateFrontComponent?: FrontComponentGenqlSelection & {
    __args: { input: UpdateFrontComponentInput };
  };
  deleteFrontComponent?: FrontComponentGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  createOneObject?: ObjectGenqlSelection & {
    __args: { input: CreateOneObjectInput };
  ...
  updateViewField?: ViewFieldGenqlSelection & {
    __args: { input: UpdateViewFieldInput };
  };
  createViewField?: ViewFieldGenqlSelection & {
    __args: { input: CreateViewFieldInput };
  };
  createManyViewFields?: ViewFieldGenqlSelection & {
    __args: { inputs: CreateViewFieldInput[] };
  };
  deleteViewField?: ViewFieldGenqlSelection & {
    __args: { input: DeleteViewFieldInput };
  };
  destroyViewField?: ViewFieldGenqlSelection & {
    __args: { input: DestroyViewFieldInput };
  };
  createOneAgent?: AgentGenqlSelection & {
    __args: { input: CreateAgentInput };
  };
  updateOneAgent?: AgentGenqlSelection & {
    __args: { input: UpdateAgentInput };
  };
  deleteOneAgent?: AgentGenqlSelection & { __args: { input: AgentIdInput } };
  checkoutSession?: BillingSessionGenqlSelection & {
    __args: {
      recurringInterval: SubscriptionInterval;
      plan: BillingPlanKey;
      requirePaymentMethod: Scalars['Boolean'];
      successUrlPath?: Scalars['String'] | null;
    };
  };
  ...
  setMeteredSubscriptionPrice?: BillingUpdateGenqlSelection & {
    __args: { priceId: Scalars['String'] };
  };
  ...
  setEnterpriseKey?: EnterpriseLicenseInfoDTOGenqlSelection & {
    __args: { enterpriseKey: Scalars['String'] };
  };
  updateWorkspaceMemberRole?: WorkspaceMemberGenqlSelection & {
    __args: { workspaceMemberId: Scalars['UUID']; roleId: Scalars['UUID'] };
  };
  createOneRole?: RoleGenqlSelection & {
    __args: { createRoleInput: CreateRoleInput };
  };
  updateOneRole?: RoleGenqlSelection & {
    __args: { updateRoleInput: UpdateRoleInput };
  };
  deleteOneRole?: { __args: { roleId: Scalars['UUID'] } };
  upsertObjectPermissions?: ObjectPermissionGenqlSelection & {
    __args: { upsertObjectPermissionsInput: UpsertObjectPermissionsInput };
  };
  upsertPermissionFlags?: PermissionFlagGenqlSelection & {
    __args: { upsertPermissionFlagsInput: UpsertPermissionFlagsInput };
  };
  upsertFieldPermissions?: FieldPermissionGenqlSelection & {
    __args: { upsertFieldPermissionsInput: UpsertFieldPermissionsInput };
  };
  ...
  assignRoleToAgent?: {
    __args: { agentId: Scalars['UUID']; roleId: Scalars['UUID'] };
  };
  ...
  resendWorkspaceInvitation?: SendInvitationsGenqlSelection & {
    __args: { appTokenId: Scalars['String'] };
  };
  sendInvitations?: SendInvitationsGenqlSelection & {
    __args: { emails: Scalars['String'][]; roleId?: Scalars['UUID'] | null };
  };
  createApprovedAccessDomain?: ApprovedAccessDomainGenqlSelection & {
    __args: { input: CreateApprovedAccessDomainInput };
  };
  deleteApprovedAccessDomain?: {
    __args: { input: DeleteApprovedAccessDomainInput };
  };
  validateApprovedAccessDomain?: ApprovedAccessDomainGenqlSelection & {
    __args: { input: ValidateApprovedAccessDomainInput };
  };
  createApiKey?: ApiKeyGenqlSelection & {
    __args: { input: CreateApiKeyInput };
  };
  updateApiKey?: ApiKeyGenqlSelection & {
    __args: { input: UpdateApiKeyInput };
  };
  revokeApiKey?: ApiKeyGenqlSelection & {
    __args: { input: RevokeApiKeyInput };
  };
  assignRoleToApiKey?: {
    __args: { apiKeyId: Scalars['UUID']; roleId: Scalars['UUID'] };
  };
  createOneField?: FieldGenqlSelection & {
    __args: { input: CreateOneFieldMetadataInput };
  };
  updateOneField?: FieldGenqlSelection & {
    __args: { input: UpdateOneFieldMetadataInput };
  };
  deleteOneField?: FieldGenqlSelection & {
    __args: { input: DeleteOneFieldInput };
  };
  createViewGroup?: ViewGroupGenqlSelection & {
    __args: { input: CreateViewGroupInput };
  };
  createManyViewGroups?: ViewGroupGenqlSelection & {
    __args: { inputs: CreateViewGroupInput[] };
  };
  updateViewGroup?: ViewGroupGenqlSelection & {
    __args: { input: UpdateViewGroupInput };
  };
  deleteViewGroup?: ViewGroupGenqlSelection & {
    __args: { input: DeleteViewGroupInput };
  };
  destroyViewGroup?: ViewGroupGenqlSelection & {
    __args: { input: DestroyViewGroupInput };
  };
  createViewFilter?: ViewFilterGenqlSelection & {
    __args: { input: CreateViewFilterInput };
  };
  updateViewFilter?: ViewFilterGenqlSelection & {
    __args: { input: UpdateViewFilterInput };
  };
  deleteViewFilter?: ViewFilterGenqlSelection & {
    __args: { input: DeleteViewFilterInput };
  };
  destroyViewFilter?: ViewFilterGenqlSelection & {
    __args: { input: DestroyViewFilterInput };
  };
  createViewFilterGroup?: ViewFilterGroupGenqlSelection & {
    __args: { input: CreateViewFilterGroupInput };
  };
  updateViewFilterGroup?: ViewFilterGroupGenqlSelection & {
    __args: { id: Scalars['String']; input: UpdateViewFilterGroupInput };
  };
  ...
  deleteUserFromWorkspace?: UserWorkspaceGenqlSelection & {
    __args: { workspaceMemberIdToDelete: Scalars['String'] };
  };
  updateUserEmail?: {
    __args: {
      newEmail: Scalars['String'];
      verifyEmailRedirectPath?: Scalars['String'] | null;
    };
  };
  resendEmailVerificationToken?: ResendEmailVerificationTokenGenqlSelection & {
    __args: { email: Scalars['String']; origin: Scalars['String'] };
  };
  activateWorkspace?: WorkspaceGenqlSelection & {
    __args: { data: ActivateWorkspaceInput };
  };
  updateWorkspace?: WorkspaceGenqlSelection & {
    __args: { data: UpdateWorkspaceInput };
  };
  deleteCurrentWorkspace?: WorkspaceGenqlSelection;
  checkCustomDomainValidRecords?: DomainValidRecordsGenqlSelection;
  createApplicationRegistration?: CreateApplicationRegistrationGenqlSelection & {
    __args: { input: CreateApplicationRegistrationInput };
  };
  updateApplicationRegistration?: ApplicationRegistrationGenqlSelection & {
    __args: { input: UpdateApplicationRegistrationInput };
  };
  deleteApplicationRegistration?: { __args: { id: Scalars['String'] } };
  rotateApplicationRegistrationClientSecret?: RotateClientSecretGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  createApplicationRegistrationVariable?: ApplicationRegistrationVariableGenqlSelection & {
    __args: { input: CreateApplicationRegistrationVariableInput };
  };
  updateApplicationRegistrationVariable?: ApplicationRegistrationVariableGenqlSelection & {
    __args: { input: UpdateApplicationRegistrationVariableInput };
  };
  deleteApplicationRegistrationVariable?: { __args: { id: Scalars['String'] } };
  uploadAppTarball?: ApplicationRegistrationGenqlSelection & {
    __args: {
      file: Scalars['Upload'];
      universalIdentifier?: Scalars['String'] | null;
    };
  };
  transferApplicationRegistrationOwnership?: ApplicationRegistrationGenqlSelection & {
    __args: {
      applicationRegistrationId: Scalars['String'];
      targetWorkspaceSubdomain: Scalars['String'];
    };
  };
  getAuthorizationUrlForSSO?: GetAuthorizationUrlForSSOGenqlSelection & {
    __args: { input: GetAuthorizationUrlForSSOInput };
  };
  getLoginTokenFromCredentials?: LoginTokenGenqlSelection & {
    __args: {
      email: Scalars['String'];
      password: Scalars['String'];
      captchaToken?: Scalars['String'] | null;
  ...
  signIn?: AvailableWorkspacesAndAccessTokensGenqlSelection & {
    __args: {
      email: Scalars['String'];
      password: Scalars['String'];
      captchaToken?: Scalars['String'] | null;
  ...
  verifyEmailAndGetLoginToken?: VerifyEmailAndGetLoginTokenGenqlSelection & {
    __args: {
  ...
  verifyEmailAndGetWorkspaceAgnosticToken?: AvailableWorkspacesAndAccessTokensGenqlSelection & {
    __args: {
      emailVerificationToken: Scalars['String'];
      email: Scalars['String'];
      captchaToken?: Scalars['String'] | null;
  ...
  getAuthTokensFromOTP?: AuthTokensGenqlSelection & {
    __args: {
      otp: Scalars['String'];
      loginToken: Scalars['String'];
      captchaToken?: Scalars['String'] | null;
  ...
  signUp?: AvailableWorkspacesAndAccessTokensGenqlSelection & {
    __args: {
      email: Scalars['String'];
      password: Scalars['String'];
      captchaToken?: Scalars['String'] | null;
  ...
  signUpInWorkspace?: SignUpGenqlSelection & {
    __args: {
      email: Scalars['String'];
      password: Scalars['String'];
      workspaceId?: Scalars['UUID'] | null;
      workspaceInviteHash?: Scalars['String'] | null;
      workspacePersonalInviteToken?: Scalars['String'] | null;
      captchaToken?: Scalars['String'] | null;
      locale?: Scalars['String'] | null;
      verifyEmailRedirectPath?: Scalars['String'] | null;
    };
  ...
  getAuthTokensFromLoginToken?: AuthTokensGenqlSelection & {
    __args: { loginToken: Scalars['String']; origin: Scalars['String'] };
  };
  authorizeApp?: AuthorizeAppGenqlSelection & {
    __args: {
      clientId: Scalars['String'];
      codeChallenge?: Scalars['String'] | null;
      redirectUrl: Scalars['String'];
      state?: Scalars['String'] | null;
      scope?: Scalars['String'] | null;
    };
  };
  renewToken?: AuthTokensGenqlSelection & {
    __args: { appToken: Scalars['String'] };
  };
  generateApiKeyToken?: ApiKeyTokenGenqlSelection & {
    __args: { apiKeyId: Scalars['UUID']; expiresAt: Scalars['String'] };
  };
  emailPasswordResetLink?: EmailPasswordResetLinkGenqlSelection & {
    __args: { email: Scalars['String']; workspaceId?: Scalars['UUID'] | null };
  };
  updatePasswordViaResetToken?: InvalidatePasswordGenqlSelection & {
    __args: {
      passwordResetToken: Scalars['String'];
      newPassword: Scalars['String'];
    };
  };
  initiateOTPProvisioning?: InitiateTwoFactorAuthenticationProvisioningGenqlSelection & {
    __args: { loginToken: Scalars['String']; origin: Scalars['String'] };
  };
  initiateOTPProvisioningForAuthenticatedUser?: InitiateTwoFactorAuthenticationProvisioningGenqlSelection;
  deleteTwoFactorAuthenticationMethod?: DeleteTwoFactorAuthenticationMethodGenqlSelection & {
    __args: { twoFactorAuthenticationMethodId: Scalars['UUID'] };
  };
  verifyTwoFactorAuthenticationMethodForAuthenticatedUser?: VerifyTwoFactorAuthenticationMethodGenqlSelection & {
    __args: { otp: Scalars['String'] };
  };
  createOIDCIdentityProvider?: SetupSsoGenqlSelection & {
    __args: { input: SetupOIDCSsoInput };
  };
  createSAMLIdentityProvider?: SetupSsoGenqlSelection & {
    __args: { input: SetupSAMLSsoInput };
  };
  deleteSSOIdentityProvider?: DeleteSsoGenqlSelection & {
    __args: { input: DeleteSsoInput };
  };
  editSSOIdentityProvider?: EditSsoGenqlSelection & {
    __args: { input: EditSsoInput };
  };
  updateMessageFolder?: MessageFolderGenqlSelection & {
    __args: { input: UpdateMessageFolderInput };
  };
  updateMessageFolders?: MessageFolderGenqlSelection & {
    __args: { input: UpdateMessageFoldersInput };
  };
  updateMessageChannel?: MessageChannelGenqlSelection & {
    __args: { input: UpdateMessageChannelInput };
  };
  deleteConnectedAccount?: ConnectedAccountDTOGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  updateCalendarChannel?: CalendarChannelGenqlSelection & {
    __args: { input: UpdateCalendarChannelInput };
  };
  createWebhook?: WebhookGenqlSelection & {
    __args: { input: CreateWebhookInput };
  };
  updateWebhook?: WebhookGenqlSelection & {
    __args: { input: UpdateWebhookInput };
  };
  ...
  evaluateAgentTurn?: AgentTurnEvaluationGenqlSelection & {
    __args: { turnId: Scalars['UUID'] };
  };
  runEvaluationInput?: AgentTurnGenqlSelection & {
    __args: { agentId: Scalars['UUID']; input: Scalars['String'] };
  };
  duplicateDashboard?: DuplicatedDashboardGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  impersonate?: ImpersonateGenqlSelection & {
    __args: { userId: Scalars['UUID']; workspaceId: Scalars['UUID'] };
  };
  startChannelSync?: ChannelSyncSuccessGenqlSelection & {
    __args: { connectedAccountId: Scalars['UUID'] };
  };
  saveImapSmtpCaldavAccount?: ImapSmtpCaldavConnectionSuccessGenqlSelection & {
    __args: {
      accountOwnerId: Scalars['UUID'];
      handle: Scalars['String'];
  ...
  updateLabPublicFeatureFlag?: FeatureFlagGenqlSelection & {
    __args: { input: UpdateLabPublicFeatureFlagInput };
  };
  userLookupAdminPanel?: UserLookupGenqlSelection & {
    __args: { userIdentifier: Scalars['String'] };
  };
  ...
  setAdminAiModelEnabled?: {
    __args: { modelId: Scalars['String']; enabled: Scalars['Boolean'] };
  };
  setAdminAiModelRecommended?: {
    __args: { modelId: Scalars['String']; recommended: Scalars['Boolean'] };
  };
  setAdminDefaultAiModel?: {
    __args: { role: AiModelRole; modelId: Scalars['String'] };
  };
  createDatabaseConfigVariable?: {
    __args: { key: Scalars['String']; value: Scalars['JSON'] };
  };
  updateDatabaseConfigVariable?: {
    __args: { key: Scalars['String']; value: Scalars['JSON'] };
  };
  deleteDatabaseConfigVariable?: { __args: { key: Scalars['String'] } };
  retryJobs?: RetryJobsResponseGenqlSelection & {
    __args: { queueName: Scalars['String']; jobIds: Scalars['String'][] };
  };
  deleteJobs?: DeleteJobsResponseGenqlSelection & {
    __args: { queueName: Scalars['String']; jobIds: Scalars['String'][] };
  };
  addAiProvider?: {
    __args: {
  ...
  addModelToProvider?: {
    __args: { providerName: Scalars['String']; modelConfig: Scalars['JSON'] };
  };
  removeModelFromProvider?: {
    __args: { providerName: Scalars['String']; modelName: Scalars['String'] };
  };
  enablePostgresProxy?: PostgresCredentialsGenqlSelection;
  disablePostgresProxy?: PostgresCredentialsGenqlSelection;
  createPublicDomain?: PublicDomainGenqlSelection & {
    __args: { domain: Scalars['String'] };
  };
  deletePublicDomain?: { __args: { domain: Scalars['String'] } };
  checkPublicDomainValidRecords?: DomainValidRecordsGenqlSelection & {
    __args: { domain: Scalars['String'] };
  };
  createEmailingDomain?: EmailingDomainGenqlSelection & {
    __args: { domain: Scalars['String']; driver: EmailingDomainDriver };
  };
  deleteEmailingDomain?: { __args: { id: Scalars['String'] } };
  verifyEmailingDomain?: EmailingDomainGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  createOneAppToken?: AppTokenGenqlSelection & {
    __args: { input: CreateOneAppTokenInput };
  };
  ...
  runWorkspaceMigration?: {
    __args: { workspaceMigration: WorkspaceMigrationInput };
  };
  ...
  createDevelopmentApplication?: DevelopmentApplicationGenqlSelection & {
    __args: { universalIdentifier: Scalars['String']; name: Scalars['String'] };
  };
  generateApplicationToken?: ApplicationTokenPairGenqlSelection & {
    __args: { applicationId: Scalars['UUID'] };
  };
  syncApplication?: WorkspaceMigrationGenqlSelection & {
    __args: { manifest: Scalars['JSON'] };
  };
  uploadApplicationFile?: FileGenqlSelection & {
    __args: {
      file: Scalars['Upload'];
      applicationUniversalIdentifier: Scalars['String'];
  ...
  renewApplicationToken?: ApplicationTokenPairGenqlSelection & {
    __args: { applicationRefreshToken: Scalars['String'] };
  };
  __typename?: boolean | number;
  __scalar?: boolean | number;
}

export interface AddQuerySubscriptionInput {
  eventStreamId: Scalars['String'];
  queryId: Scalars['String'];
  operationSignature: Scalars['JSON'];
}

export interface RemoveQueryFromEventStreamInput {
  eventStreamId: Scalars['String'];
  queryId: Scalars['String'];
}
...
export interface CreateNavigationMenuItemInput {
  ...
  targetRecordId?: Scalars['UUID'] | null;
  targetObjectMetadataId?: Scalars['UUID'] | null;
...
export interface CreatePageLayoutWidgetInput {
  pageLayoutTabId: Scalars['UUID'];
  title: Scalars['String'];
  type: WidgetType;
  objectMetadataId?: Scalars['UUID'] | null;
  gridPosition: GridPositionInput;
  position?: Scalars['JSON'] | null;
  configuration: Scalars['JSON'];
}
...
export interface UpdatePageLayoutWidgetInput {
  ...
  position?: Scalars['JSON'] | null;
  configuration?: Scalars['JSON'] | null;
  conditionalDisplay?: Scalars['JSON'] | null;
}

export interface CreatePageLayoutTabInput {
  title: Scalars['String'];
  position?: Scalars['Float'] | null;
  pageLayoutId: Scalars['UUID'];
  layoutMode?: PageLayoutTabLayoutMode | null;
}

export interface UpdatePageLayoutTabInput {
  title?: Scalars['String'] | null;
  position?: Scalars['Float'] | null;
  icon?: Scalars['String'] | null;
  layoutMode?: PageLayoutTabLayoutMode | null;
...
export interface CreatePageLayoutInput {
  name: Scalars['String'];
...
export interface UpdatePageLayoutWithTabsInput {
  name: Scalars['String'];
  type: PageLayoutType;
  objectMetadataId?: Scalars['UUID'] | null;
...
export interface UpdatePageLayoutTabWithWidgetsInput {
  id: Scalars['UUID'];
  title: Scalars['String'];
  position: Scalars['Float'];
  icon?: Scalars['String'] | null;
...
export interface CreateViewInput {
  ...
  shouldHideEmptyGroups?: Scalars['Boolean'] | null;
  openRecordIn?: ViewOpenRecordIn | null;
  ...
  mainGroupByFieldMetadataId?: Scalars['UUID'] | null;
  visibility?: ViewVisibility | null;
}
...
export interface CreateViewSortInput {
  id?: Scalars['UUID'] | null;
  fieldMetadataId: Scalars['UUID'];
  direction?: ViewSortDirection | null;
  viewId: Scalars['UUID'];
}
...
export interface UpdateViewSortInputUpdates {
  direction?: ViewSortDirection | null;
}
...
export interface UpdateViewFieldGroupInputUpdates {
  name?: Scalars['String'] | null;
  position?: Scalars['Float'] | null;
...
export interface CreateViewFieldGroupInput {
  id?: Scalars['UUID'] | null;
  name: Scalars['String'];
  viewId: Scalars['UUID'];
  position?: Scalars['Float'] | null;
...
export interface UpsertFieldsWidgetGroupInput {
  id: Scalars['UUID'];
  name: Scalars['String'];
  position: Scalars['Float'];
  isVisible: Scalars['Boolean'];
...
export interface CreateLogicFunctionFromSourceInput {
  id?: Scalars['UUID'] | null;
  universalIdentifier?: Scalars['UUID'] | null;
  name: Scalars['String'];
  description?: Scalars['String'] | null;
  timeoutSeconds?: Scalars['Float'] | null;
  toolInputSchema?: Scalars['JSON'] | null;
  isTool?: Scalars['Boolean'] | null;
  source?: Scalars['JSON'] | null;
  cronTriggerSettings?: Scalars['JSON'] | null;
  databaseEventTriggerSettings?: Scalars['JSON'] | null;
  httpRouteTriggerSettings?: Scalars['JSON'] | null;
}
...
export interface UpdateLogicFunctionFromSourceInputUpdates {
  name?: Scalars['String'] | null;
  description?: Scalars['String'] | null;
  timeoutSeconds?: Scalars['Float'] | null;
  sourceHandlerCode?: Scalars['String'] | null;
  toolInputSchema?: Scalars['JSON'] | null;
  handlerName?: Scalars['String'] | null;
  sourceHandlerPath?: Scalars['String'] | null;
  isTool?: Scalars['Boolean'] | null;
  cronTriggerSettings?: Scalars['JSON'] | null;
  databaseEventTriggerSettings?: Scalars['JSON'] | null;
  httpRouteTriggerSettings?: Scalars['JSON'] | null;
...
export interface CreateCommandMenuItemInput {
  workflowVersionId?: Scalars['UUID'] | null;
  frontComponentId?: Scalars['UUID'] | null;
  engineComponentKey?: EngineComponentKey | null;
  label: Scalars['String'];
  icon?: Scalars['String'] | null;
  shortLabel?: Scalars['String'] | null;
  position?: Scalars['Float'] | null;
  isPinned?: Scalars['Boolean'] | null;
  availabilityType?: CommandMenuItemAvailabilityType | null;
  hotKeys?: Scalars['String'][] | null;
  conditionalAvailabilityExpression?: Scalars['String'] | null;
  availabilityObjectMetadataId?: Scalars['UUID'] | null;
}
...
export interface CreateFrontComponentInput {
  id?: Scalars['UUID'] | null;
  name: Scalars['String'];
  description?: Scalars['String'] | null;
  sourceComponentPath: Scalars['String'];
...
export interface UpdateFrontComponentInputUpdates {
  name?: Scalars['String'] | null;
  description?: Scalars['String'] | null;
}
...
export interface CreateObjectInput {
  ...
  color?: Scalars['String'] | null;
  skipNameField?: Scalars['Boolean'] | null;
  isRemote?: Scalars['Boolean'] | null;
  primaryKeyColumnType?: Scalars['String'] | null;
  primaryKeyFieldMetadataSettings?: Scalars['JSON'] | null;
...
export interface UpdateObjectPayload {
  ...
  nameSingular?: Scalars['String'] | null;
  namePlural?: Scalars['String'] | null;
  description?: Scalars['String'] | null;
  icon?: Scalars['String'] | null;
  shortcut?: Scalars['String'] | null;
  color?: Scalars['String'] | null;
...
export interface UpdateViewFieldInputUpdates {
  isVisible?: Scalars['Boolean'] | null;
  size?: Scalars['Float'] | null;
  position?: Scalars['Float'] | null;
  aggregateOperation?: AggregateOperations | null;
  viewFieldGroupId?: Scalars['UUID'] | null;
}

export interface CreateViewFieldInput {
  id?: Scalars['UUID'] | null;
  fieldMetadataId: Scalars['UUID'];
  viewId: Scalars['UUID'];
  isVisible?: Scalars['Boolean'] | null;
...
export interface CreateAgentInput {
  ...
  evaluationInputs?: Scalars['String'][] | null;
}
...
export interface CreateRoleInput {
  ...
  description?: Scalars['String'] | null;
  icon?: Scalars['String'] | null;
  canUpdateAllSettings?: Scalars['Boolean'] | null;
  canAccessAllTools?: Scalars['Boolean'] | null;
  canReadAllObjectRecords?: Scalars['Boolean'] | null;
  canUpdateAllObjectRecords?: Scalars['Boolean'] | null;
  canSoftDeleteAllObjectRecords?: Scalars['Boolean'] | null;
  canDestroyAllObjectRecords?: Scalars['Boolean'] | null;
  canBeAssignedToUsers?: Scalars['Boolean'] | null;
  canBeAssignedToAgents?: Scalars['Boolean'] | null;
  canBeAssignedToApiKeys?: Scalars['Boolean'] | null;
}
...
export interface UpsertObjectPermissionsInput {
  roleId: Scalars['UUID'];
...
export interface UpsertPermissionFlagsInput {
  roleId: Scalars['UUID'];
  permissionFlagKeys: PermissionFlagType[];
}

export interface UpsertFieldPermissionsInput {
  roleId: Scalars['UUID'];
...
export interface UpsertRowLevelPermissionPredicatesInput {
  roleId: Scalars['UUID'];
  objectMetadataId: Scalars['UUID'];
...
export interface RowLevelPermissionPredicateInput {
  ...
  workspaceMemberFieldMetadataId?: Scalars['String'] | null;
  workspaceMemberSubFieldName?: Scalars['String'] | null;
  rowLevelPermissionPredicateGroupId?: Scalars['UUID'] | null;
  positionInRowLevelPermissionPredicateGroup?: Scalars['Float'] | null;
}

export interface RowLevelPermissionPredicateGroupInput {
  id?: Scalars['UUID'] | null;
  objectMetadataId: Scalars['UUID'];
  parentRowLevelPermissionPredicateGroupId?: Scalars['UUID'] | null;
  logicalOperator: RowLevelPermissionPredicateGroupLogicalOperator;
  positionInRowLevelPermissionPredicateGroup?: Scalars['Float'] | null;
}

export interface CreateApprovedAccessDomainInput {
  domain: Scalars['String'];
  email: Scalars['String'];
}

export interface DeleteApprovedAccessDomainInput {
  id: Scalars['UUID'];
}

export interface ValidateApprovedAccessDomainInput {
...
export interface CreateFieldInput {
  ...
  isLabelSyncedWithName?: Scalars['Boolean'] | null;
  objectMetadataId: Scalars['UUID'];
  isRemoteCreation?: Scalars['Boolean'] | null;
  relationCreationPayload?: Scalars['JSON'] | null;
  morphRelationsCreationPayload?: Scalars['JSON'][] | null;
}
...
export interface UpdateFieldInput {
  ...
  settings?: Scalars['JSON'] | null;
  isLabelSyncedWithName?: Scalars['Boolean'] | null;
  morphRelationsUpdatePayload?: Scalars['JSON'][] | null;
}
...
export interface CreateViewGroupInput {
  id?: Scalars['UUID'] | null;
  isVisible?: Scalars['Boolean'] | null;
  fieldValue: Scalars['String'];
  position?: Scalars['Float'] | null;
...
export interface UpdateViewGroupInputUpdates {
...
export interface CreateViewFilterInput {
  id?: Scalars['UUID'] | null;
  fieldMetadataId: Scalars['UUID'];
...
export interface UpdateViewFilterInputUpdates {
  fieldMetadataId?: Scalars['UUID'] | null;
  operand?: ViewFilterOperand | null;
  value?: Scalars['JSON'] | null;
  viewFilterGroupId?: Scalars['UUID'] | null;
...
export interface CreateViewFilterGroupInput {
  id?: Scalars['UUID'] | null;
  parentViewFilterGroupId?: Scalars['UUID'] | null;
  logicalOperator?: ViewFilterGroupLogicalOperator | null;
  positionInViewFilterGroup?: Scalars['Float'] | null;
  viewId: Scalars['UUID'];
}

export interface UpdateViewFilterGroupInput {
  id?: Scalars['UUID'] | null;
  parentViewFilterGroupId?: Scalars['UUID'] | null;
  logicalOperator?: ViewFilterGroupLogicalOperator | null;
  positionInViewFilterGroup?: Scalars['Float'] | null;
...
export interface UpdateWorkspaceInput {
  ...
  isPublicInviteLinkEnabled?: Scalars['Boolean'] | null;
  allowImpersonation?: Scalars['Boolean'] | null;
  isGoogleAuthEnabled?: Scalars['Boolean'] | null;
  isMicrosoftAuthEnabled?: Scalars['Boolean'] | null;
  isPasswordAuthEnabled?: Scalars['Boolean'] | null;
  isGoogleAuthBypassEnabled?: Scalars['Boolean'] | null;
  isMicrosoftAuthBypassEnabled?: Scalars['Boolean'] | null;
  isPasswordAuthBypassEnabled?: Scalars['Boolean'] | null;
  defaultRoleId?: Scalars['UUID'] | null;
  isTwoFactorAuthenticationEnforced?: Scalars['Boolean'] | null;
  trashRetentionDays?: Scalars['Float'] | null;
  eventLogRetentionDays?: Scalars['Float'] | null;
  fastModel?: Scalars['String'] | null;
  smartModel?: Scalars['String'] | null;
  aiAdditionalInstructions?: Scalars['String'] | null;
  editableProfileFields?: Scalars['String'][] | null;
  enabledAiModelIds?: Scalars['String'][] | null;
  useRecommendedModels?: Scalars['Boolean'] | null;
}

export interface CreateApplicationRegistrationInput {
  name: Scalars['String'];
  description?: Scalars['String'] | null;
  logoUrl?: Scalars['String'] | null;
  author?: Scalars['String'] | null;
  universalIdentifier?: Scalars['String'] | null;
  oAuthRedirectUris?: Scalars['String'][] | null;
  oAuthScopes?: Scalars['String'][] | null;
  websiteUrl?: Scalars['String'] | null;
  termsUrl?: Scalars['String'] | null;
}

export interface UpdateApplicationRegistrationInput {
  id: Scalars['String'];
  update: UpdateApplicationRegistrationPayload;
}

export interface UpdateApplicationRegistrationPayload {
  name?: Scalars['String'] | null;
  description?: Scalars['String'] | null;
  logoUrl?: Scalars['String'] | null;
  author?: Scalars['String'] | null;
  ...
  websiteUrl?: Scalars['String'] | null;
  termsUrl?: Scalars['String'] | null;
  isListed?: Scalars['Boolean'] | null;
}

export interface CreateApplicationRegistrationVariableInput {
  applicationRegistrationId: Scalars['String'];
  key: Scalars['String'];
  value: Scalars['String'];
  description?: Scalars['String'] | null;
  isSecret?: Scalars['Boolean'] | null;
}
...
export interface GetAuthorizationUrlForSSOInput {
  identityProviderId: Scalars['UUID'];
  workspaceInviteHash?: Scalars['String'] | null;
}

export interface SetupOIDCSsoInput {
  name: Scalars['String'];
  issuer: Scalars['String'];
  clientID: Scalars['String'];
  clientSecret: Scalars['String'];
...
export interface SetupSAMLSsoInput {
  name: Scalars['String'];
  issuer: Scalars['String'];
  id: Scalars['UUID'];
...
export interface DeleteSsoInput {
  identityProviderId: Scalars['UUID'];
}

export interface EditSsoInput {
  id: Scalars['UUID'];
  status: SSOIdentityProviderStatus;
}

export interface UpdateMessageFolderInput {
  id: Scalars['UUID'];
  update: UpdateMessageFolderInputUpdates;
}

export interface UpdateMessageFolderInputUpdates {
  isSynced?: Scalars['Boolean'] | null;
}

export interface UpdateMessageFoldersInput {
  ids: Scalars['UUID'][];
  update: UpdateMessageFolderInputUpdates;
}

export interface UpdateMessageChannelInput {
  id: Scalars['UUID'];
  update: UpdateMessageChannelInputUpdates;
}

export interface UpdateMessageChannelInputUpdates {
  visibility?: MessageChannelVisibility | null;
  isContactAutoCreationEnabled?: Scalars['Boolean'] | null;
  contactAutoCreationPolicy?: MessageChannelContactAutoCreationPolicy | null;
  messageFolderImportPolicy?: MessageFolderImportPolicy | null;
...
export interface UpdateCalendarChannelInput {
  id: Scalars['UUID'];
  update: UpdateCalendarChannelInputUpdates;
}

export interface UpdateCalendarChannelInputUpdates {
  visibility?: CalendarChannelVisibility | null;
  isContactAutoCreationEnabled?: Scalars['Boolean'] | null;
  contactAutoCreationPolicy?: CalendarChannelContactAutoCreationPolicy | null;
  isSyncEnabled?: Scalars['Boolean'] | null;
}
...
export interface UpdateWebhookInputUpdates {
  targetUrl?: Scalars['String'] | null;
  operations?: Scalars['String'][] | null;
  description?: Scalars['String'] | null;
  secret?: Scalars['String'] | null;
}
...
export interface EmailAccountConnectionParameters {
  IMAP?: ConnectionParameters | null;
  SMTP?: ConnectionParameters | null;
  CALDAV?: ConnectionParameters | null;
}
...
export interface UpdateLabPublicFeatureFlagInput {
...
export interface WorkspaceMigrationDeleteActionInput {
...
export interface SubscriptionGenqlSelection {
  onEventSubscription?: EventSubscriptionGenqlSelection & {
    __args: { eventStreamId: Scalars['String'] };
  };
  logicFunctionLogs?: LogicFunctionLogsGenqlSelection & {
    __args: { input: LogicFunctionLogsInput };
  };
  __typename?: boolean | number;
  __scalar?: boolean | number;
}

export interface LogicFunctionLogsInput {
  applicationId?: Scalars['UUID'] | null;
  applicationUniversalIdentifier?: Scalars['UUID'] | null;
  name?: Scalars['String'] | null;
  id?: Scalars['UUID'] | null;
  universalIdentifier?: Scalars['UUID'] | null;
}

const BillingProductDTO_possibleTypes: string[] = [
  'BillingLicensedProduct',
  'BillingMeteredProduct',
];
export const isBillingProductDTO = (
  obj?: { __typename?: any } | null,
): obj is BillingProductDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingProductDTO"');
...
const ApplicationRegistrationVariable_possibleTypes: string[] = [
  'ApplicationRegistrationVariable',
];
export const isApplicationRegistrationVariable = (
  obj?: { __typename?: any } | null,
): obj is ApplicationRegistrationVariable => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationRegistrationVariable"',
    );
  return ApplicationRegistrationVariable_possibleTypes.includes(obj.__typename);
};

const ApplicationRegistration_possibleTypes: string[] = [
  'ApplicationRegistration',
];
export const isApplicationRegistration = (
  obj?: { __typename?: any } | null,
): obj is ApplicationRegistration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApplicationRegistration"');
  return ApplicationRegistration_possibleTypes.includes(obj.__typename);
};

const TwoFactorAuthenticationMethodSummary_possibleTypes: string[] = [
  'TwoFactorAuthenticationMethodSummary',
];
export const isTwoFactorAuthenticationMethodSummary = (
  obj?: { __typename?: any } | null,
): obj is TwoFactorAuthenticationMethodSummary => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isTwoFactorAuthenticationMethodSummary"',
    );
  return TwoFactorAuthenticationMethodSummary_possibleTypes.includes(
    obj.__typename,
  );
};

const RowLevelPermissionPredicateGroup_possibleTypes: string[] = [
  'RowLevelPermissionPredicateGroup',
];
export const isRowLevelPermissionPredicateGroup = (
  obj?: { __typename?: any } | null,
): obj is RowLevelPermissionPredicateGroup => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isRowLevelPermissionPredicateGroup"',
    );
  return RowLevelPermissionPredicateGroup_possibleTypes.includes(
    obj.__typename,
  );
};

const RowLevelPermissionPredicate_possibleTypes: string[] = [
  'RowLevelPermissionPredicate',
];
export const isRowLevelPermissionPredicate = (
  obj?: { __typename?: any } | null,
): obj is RowLevelPermissionPredicate => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRowLevelPermissionPredicate"');
...
export const isObjectPermission = (
  obj?: { __typename?: any } | null,
): obj is ObjectPermission => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isObjectPermission"');
  return ObjectPermission_possibleTypes.includes(obj.__typename);
};

const UserWorkspace_possibleTypes: string[] = ['UserWorkspace'];
export const isUserWorkspace = (
  obj?: { __typename?: any } | null,
): obj is UserWorkspace => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUserWorkspace"');
...
export const isFullName = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFullName"');
...
export const isWorkspaceMember = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkspaceMember"');
...
export const isFieldPermission = (
  obj?: { __typename?: any } | null,
): obj is FieldPermission => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFieldPermission"');
  return FieldPermission_possibleTypes.includes(obj.__typename);
};

const PermissionFlag_possibleTypes: string[] = ['PermissionFlag'];
export const isPermissionFlag = (
  obj?: { __typename?: any } | null,
): obj is PermissionFlag => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPermissionFlag"');
  return PermissionFlag_possibleTypes.includes(obj.__typename);
};

const ApiKeyForRole_possibleTypes: string[] = ['ApiKeyForRole'];
export const isApiKeyForRole = (
  obj?: { __typename?: any } | null,
): obj is ApiKeyForRole => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApiKeyForRole"');
...
const ApplicationRegistrationSummary_possibleTypes: string[] = [
  'ApplicationRegistrationSummary',
];
export const isApplicationRegistrationSummary = (
  obj?: { __typename?: any } | null,
): obj is ApplicationRegistrationSummary => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationRegistrationSummary"',
    );
...
export const isApplicationVariable = (
  obj?: { __typename?: any } | null,
): obj is ApplicationVariable => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApplicationVariable"');
  return ApplicationVariable_possibleTypes.includes(obj.__typename);
};

const LogicFunction_possibleTypes: string[] = ['LogicFunction'];
export const isLogicFunction = (
  obj?: { __typename?: any } | null,
): obj is LogicFunction => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isLogicFunction"');
  return LogicFunction_possibleTypes.includes(obj.__typename);
};

const StandardOverrides_possibleTypes: string[] = ['StandardOverrides'];
export const isStandardOverrides = (
  obj?: { __typename?: any } | null,
): obj is StandardOverrides => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isStandardOverrides"');
...
export const isIndexField = (
  obj?: { __typename?: any } | null,
): obj is IndexField => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isIndexField"');
...
const ObjectStandardOverrides_possibleTypes: string[] = [
  'ObjectStandardOverrides',
];
export const isObjectStandardOverrides = (
  obj?: { __typename?: any } | null,
): obj is ObjectStandardOverrides => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isObjectStandardOverrides"');
...
export const isAppToken = (
  obj?: { __typename?: any } | null,
): obj is AppToken => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAppToken"');
...
export const isRatioAggregateConfig = (
  obj?: { __typename?: any } | null,
): obj is RatioAggregateConfig => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRatioAggregateConfig"');
  return RatioAggregateConfig_possibleTypes.includes(obj.__typename);
};

const RichTextBody_possibleTypes: string[] = ['RichTextBody'];
export const isRichTextBody = (
  obj?: { __typename?: any } | null,
): obj is RichTextBody => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRichTextBody"');
...
export const isGridPosition = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isGridPosition"');
  return GridPosition_possibleTypes.includes(obj.__typename);
};

const PageLayoutWidget_possibleTypes: string[] = ['PageLayoutWidget'];
export const isPageLayoutWidget = (
  obj?: { __typename?: any } | null,
): obj is PageLayoutWidget => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPageLayoutWidget"');
  return PageLayoutWidget_possibleTypes.includes(obj.__typename);
};

const PageLayoutWidgetPosition_possibleTypes: string[] = [
  'PageLayoutWidgetGridPosition',
  'PageLayoutWidgetVerticalListPosition',
  'PageLayoutWidgetCanvasPosition',
];
export const isPageLayoutWidgetPosition = (
  obj?: { __typename?: any } | null,
): obj is PageLayoutWidgetPosition => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPageLayoutWidgetPosition"');
  return PageLayoutWidgetPosition_possibleTypes.includes(obj.__typename);
};

const PageLayoutWidgetGridPosition_possibleTypes: string[] = [
  'PageLayoutWidgetGridPosition',
];
export const isPageLayoutWidgetGridPosition = (
  obj?: { __typename?: any } | null,
): obj is PageLayoutWidgetGridPosition => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isPageLayoutWidgetGridPosition"',
    );
  return PageLayoutWidgetGridPosition_possibleTypes.includes(obj.__typename);
};

const PageLayoutWidgetVerticalListPosition_possibleTypes: string[] = [
  'PageLayoutWidgetVerticalListPosition',
];
export const isPageLayoutWidgetVerticalListPosition = (
  obj?: { __typename?: any } | null,
): obj is PageLayoutWidgetVerticalListPosition => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isPageLayoutWidgetVerticalListPosition"',
    );
  return PageLayoutWidgetVerticalListPosition_possibleTypes.includes(
    obj.__typename,
  );
};

const PageLayoutWidgetCanvasPosition_possibleTypes: string[] = [
  'PageLayoutWidgetCanvasPosition',
];
export const isPageLayoutWidgetCanvasPosition = (
  obj?: { __typename?: any } | null,
): obj is PageLayoutWidgetCanvasPosition => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isPageLayoutWidgetCanvasPosition"',
    );
  return PageLayoutWidgetCanvasPosition_possibleTypes.includes(obj.__typename);
};

const WidgetConfiguration_possibleTypes: string[] = [
  'AggregateChartConfiguration',
  'StandaloneRichTextConfiguration',
  'PieChartConfiguration',
  'LineChartConfiguration',
...
export const isWidgetConfiguration = (
  obj?: { __typename?: any } | null,
): obj is WidgetConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWidgetConfiguration"');
  return WidgetConfiguration_possibleTypes.includes(obj.__typename);
};

const AggregateChartConfiguration_possibleTypes: string[] = [
  'AggregateChartConfiguration',
];
export const isAggregateChartConfiguration = (
  obj?: { __typename?: any } | null,
): obj is AggregateChartConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAggregateChartConfiguration"');
  return AggregateChartConfiguration_possibleTypes.includes(obj.__typename);
};

const StandaloneRichTextConfiguration_possibleTypes: string[] = [
  'StandaloneRichTextConfiguration',
];
export const isStandaloneRichTextConfiguration = (
  obj?: { __typename?: any } | null,
): obj is StandaloneRichTextConfiguration => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isStandaloneRichTextConfiguration"',
    );
...
export const isPieChartConfiguration = (
  obj?: { __typename?: any } | null,
): obj is PieChartConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPieChartConfiguration"');
  return PieChartConfiguration_possibleTypes.includes(obj.__typename);
};

const LineChartConfiguration_possibleTypes: string[] = [
  'LineChartConfiguration',
];
export const isLineChartConfiguration = (
  obj?: { __typename?: any } | null,
): obj is LineChartConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isLineChartConfiguration"');
...
export const isIframeConfiguration = (
  obj?: { __typename?: any } | null,
): obj is IframeConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isIframeConfiguration"');
  return IframeConfiguration_possibleTypes.includes(obj.__typename);
};

const GaugeChartConfiguration_possibleTypes: string[] = [
  'GaugeChartConfiguration',
];
export const isGaugeChartConfiguration = (
  obj?: { __typename?: any } | null,
): obj is GaugeChartConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isGaugeChartConfiguration"');
...
export const isBarChartConfiguration = (
  obj?: { __typename?: any } | null,
): obj is BarChartConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBarChartConfiguration"');
...
export const isCalendarConfiguration = (
  obj?: { __typename?: any } | null,
): obj is CalendarConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCalendarConfiguration"');
  return CalendarConfiguration_possibleTypes.includes(obj.__typename);
};

const FrontComponentConfiguration_possibleTypes: string[] = [
  'FrontComponentConfiguration',
];
export const isFrontComponentConfiguration = (
  obj?: { __typename?: any } | null,
): obj is FrontComponentConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFrontComponentConfiguration"');
...
export const isEmailsConfiguration = (
  obj?: { __typename?: any } | null,
): obj is EmailsConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEmailsConfiguration"');
...
export const isFieldConfiguration = (
  obj?: { __typename?: any } | null,
): obj is FieldConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFieldConfiguration"');
  return FieldConfiguration_possibleTypes.includes(obj.__typename);
};

const FieldRichTextConfiguration_possibleTypes: string[] = [
  'FieldRichTextConfiguration',
];
export const isFieldRichTextConfiguration = (
  obj?: { __typename?: any } | null,
): obj is FieldRichTextConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFieldRichTextConfiguration"');
...
export const isFieldsConfiguration = (
  obj?: { __typename?: any } | null,
): obj is FieldsConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFieldsConfiguration"');
...
export const isFilesConfiguration = (
  obj?: { __typename?: any } | null,
): obj is FilesConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFilesConfiguration"');
...
export const isNotesConfiguration = (
  obj?: { __typename?: any } | null,
): obj is NotesConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isNotesConfiguration"');
...
export const isTasksConfiguration = (
  obj?: { __typename?: any } | null,
): obj is TasksConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTasksConfiguration"');
...
export const isTimelineConfiguration = (
  obj?: { __typename?: any } | null,
): obj is TimelineConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTimelineConfiguration"');
...
export const isViewConfiguration = (
  obj?: { __typename?: any } | null,
): obj is ViewConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isViewConfiguration"');
...
export const isWorkflowConfiguration = (
  obj?: { __typename?: any } | null,
): obj is WorkflowConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkflowConfiguration"');
  return WorkflowConfiguration_possibleTypes.includes(obj.__typename);
};

const WorkflowRunConfiguration_possibleTypes: string[] = [
  'WorkflowRunConfiguration',
];
export const isWorkflowRunConfiguration = (
  obj?: { __typename?: any } | null,
): obj is WorkflowRunConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkflowRunConfiguration"');
  return WorkflowRunConfiguration_possibleTypes.includes(obj.__typename);
};

const WorkflowVersionConfiguration_possibleTypes: string[] = [
  'WorkflowVersionConfiguration',
];
export const isWorkflowVersionConfiguration = (
  obj?: { __typename?: any } | null,
): obj is WorkflowVersionConfiguration => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isWorkflowVersionConfiguration"',
    );
...
export const isPageLayoutTab = (
  obj?: { __typename?: any } | null,
): obj is PageLayoutTab => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPageLayoutTab"');
  return PageLayoutTab_possibleTypes.includes(obj.__typename);
};

const PageLayout_possibleTypes: string[] = ['PageLayout'];
export const isPageLayout = (
  obj?: { __typename?: any } | null,
): obj is PageLayout => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPageLayout"');
...
export const isAnalytics = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAnalytics"');
  return Analytics_possibleTypes.includes(obj.__typename);
};

const BillingSubscriptionSchedulePhaseItem_possibleTypes: string[] = [
  'BillingSubscriptionSchedulePhaseItem',
];
export const isBillingSubscriptionSchedulePhaseItem = (
  obj?: { __typename?: any } | null,
): obj is BillingSubscriptionSchedulePhaseItem => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isBillingSubscriptionSchedulePhaseItem"',
    );
  return BillingSubscriptionSchedulePhaseItem_possibleTypes.includes(
    obj.__typename,
  );
};

const BillingSubscriptionSchedulePhase_possibleTypes: string[] = [
  'BillingSubscriptionSchedulePhase',
];
export const isBillingSubscriptionSchedulePhase = (
  obj?: { __typename?: any } | null,
): obj is BillingSubscriptionSchedulePhase => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isBillingSubscriptionSchedulePhase"',
    );
  return BillingSubscriptionSchedulePhase_possibleTypes.includes(
    obj.__typename,
  );
};

const BillingProductMetadata_possibleTypes: string[] = [
  'BillingProductMetadata',
];
export const isBillingProductMetadata = (
  obj?: { __typename?: any } | null,
): obj is BillingProductMetadata => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingProductMetadata"');
...
export const isBillingPriceLicensed = (
  obj?: { __typename?: any } | null,
): obj is BillingPriceLicensed => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingPriceLicensed"');
...
export const isBillingPriceTier = (
  obj?: { __typename?: any } | null,
): obj is BillingPriceTier => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingPriceTier"');
...
export const isBillingPriceMetered = (
  obj?: { __typename?: any } | null,
): obj is BillingPriceMetered => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingPriceMetered"');
  return BillingPriceMetered_possibleTypes.includes(obj.__typename);
};

const BillingProduct_possibleTypes: string[] = ['BillingProduct'];
export const isBillingProduct = (
  obj?: { __typename?: any } | null,
): obj is BillingProduct => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingProduct"');
  return BillingProduct_possibleTypes.includes(obj.__typename);
};

const BillingLicensedProduct_possibleTypes: string[] = [
  'BillingLicensedProduct',
];
export const isBillingLicensedProduct = (
  obj?: { __typename?: any } | null,
): obj is BillingLicensedProduct => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingLicensedProduct"');
...
export const isBillingMeteredProduct = (
  obj?: { __typename?: any } | null,
): obj is BillingMeteredProduct => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingMeteredProduct"');
  return BillingMeteredProduct_possibleTypes.includes(obj.__typename);
};

const BillingSubscriptionItem_possibleTypes: string[] = [
  'BillingSubscriptionItem',
];
export const isBillingSubscriptionItem = (
  obj?: { __typename?: any } | null,
): obj is BillingSubscriptionItem => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingSubscriptionItem"');
...
export const isBillingSubscription = (
  obj?: { __typename?: any } | null,
): obj is BillingSubscription => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingSubscription"');
...
export const isBillingEndTrialPeriod = (
  obj?: { __typename?: any } | null,
): obj is BillingEndTrialPeriod => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingEndTrialPeriod"');
  return BillingEndTrialPeriod_possibleTypes.includes(obj.__typename);
};

const BillingMeteredProductUsage_possibleTypes: string[] = [
  'BillingMeteredProductUsage',
];
export const isBillingMeteredProductUsage = (
  obj?: { __typename?: any } | null,
): obj is BillingMeteredProductUsage => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingMeteredProductUsage"');
...
export const isBillingPlan = (
  obj?: { __typename?: any } | null,
): obj is BillingPlan => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingPlan"');
  return BillingPlan_possibleTypes.includes(obj.__typename);
};

const BillingSession_possibleTypes: string[] = ['BillingSession'];
export const isBillingSession = (
  obj?: { __typename?: any } | null,
): obj is BillingSession => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingSession"');
  return BillingSession_possibleTypes.includes(obj.__typename);
};

const BillingUpdate_possibleTypes: string[] = ['BillingUpdate'];
export const isBillingUpdate = (
  obj?: { __typename?: any } | null,
): obj is BillingUpdate => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingUpdate"');
  return BillingUpdate_possibleTypes.includes(obj.__typename);
};

const EnterpriseLicenseInfoDTO_possibleTypes: string[] = [
  'EnterpriseLicenseInfoDTO',
];
export const isEnterpriseLicenseInfoDTO = (
  obj?: { __typename?: any } | null,
): obj is EnterpriseLicenseInfoDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEnterpriseLicenseInfoDTO"');
  return EnterpriseLicenseInfoDTO_possibleTypes.includes(obj.__typename);
};

const EnterpriseSubscriptionStatusDTO_possibleTypes: string[] = [
  'EnterpriseSubscriptionStatusDTO',
];
export const isEnterpriseSubscriptionStatusDTO = (
  obj?: { __typename?: any } | null,
): obj is EnterpriseSubscriptionStatusDTO => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isEnterpriseSubscriptionStatusDTO"',
    );
...
export const isOnboardingStepSuccess = (
  obj?: { __typename?: any } | null,
): obj is OnboardingStepSuccess => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isOnboardingStepSuccess"');
...
export const isApprovedAccessDomain = (
  obj?: { __typename?: any } | null,
): obj is ApprovedAccessDomain => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApprovedAccessDomain"');
...
export const isFileWithSignedUrl = (
  obj?: { __typename?: any } | null,
): obj is FileWithSignedUrl => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFileWithSignedUrl"');
...
export const isWorkspaceInvitation = (
  obj?: { __typename?: any } | null,
): obj is WorkspaceInvitation => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkspaceInvitation"');
...
export const isSendInvitations = (
  obj?: { __typename?: any } | null,
): obj is SendInvitations => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSendInvitations"');
  return SendInvitations_possibleTypes.includes(obj.__typename);
};

const ResendEmailVerificationToken_possibleTypes: string[] = [
  'ResendEmailVerificationToken',
];
export const isResendEmailVerificationToken = (
  obj?: { __typename?: any } | null,
): obj is ResendEmailVerificationToken => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isResendEmailVerificationToken"',
    );
...
export const isWorkspaceUrls = (
  obj?: { __typename?: any } | null,
): obj is WorkspaceUrls => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkspaceUrls"');
  return WorkspaceUrls_possibleTypes.includes(obj.__typename);
};

const SSOConnection_possibleTypes: string[] = ['SSOConnection'];
export const isSSOConnection = (
  obj?: { __typename?: any } | null,
): obj is SSOConnection => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSSOConnection"');
...
export const isAvailableWorkspace = (
  obj?: { __typename?: any } | null,
): obj is AvailableWorkspace => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAvailableWorkspace"');
...
export const isAvailableWorkspaces = (
  obj?: { __typename?: any } | null,
): obj is AvailableWorkspaces => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAvailableWorkspaces"');
  return AvailableWorkspaces_possibleTypes.includes(obj.__typename);
};

const DeletedWorkspaceMember_possibleTypes: string[] = [
  'DeletedWorkspaceMember',
];
export const isDeletedWorkspaceMember = (
  obj?: { __typename?: any } | null,
): obj is DeletedWorkspaceMember => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isDeletedWorkspaceMember"');
...
export const isBillingEntitlement = (
  obj?: { __typename?: any } | null,
): obj is BillingEntitlement => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingEntitlement"');
  return BillingEntitlement_possibleTypes.includes(obj.__typename);
};

const DomainRecord_possibleTypes: string[] = ['DomainRecord'];
export const isDomainRecord = (
  obj?: { __typename?: any } | null,
): obj is DomainRecord => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isDomainRecord"');
...
export const isDomainValidRecords = (
  obj?: { __typename?: any } | null,
): obj is DomainValidRecords => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isDomainValidRecords"');
...
export const isFeatureFlag = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFeatureFlag"');
...
export const isSSOIdentityProvider = (
  obj?: { __typename?: any } | null,
): obj is SSOIdentityProvider => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSSOIdentityProvider"');
  return SSOIdentityProvider_possibleTypes.includes(obj.__typename);
};

const AuthProviders_possibleTypes: string[] = ['AuthProviders'];
export const isAuthProviders = (
  obj?: { __typename?: any } | null,
): obj is AuthProviders => {
  if (!obj?.__typename)
...
export const isAuthBypassProviders = (
  obj?: { __typename?: any } | null,
): obj is AuthBypassProviders => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAuthBypassProviders"');
...
export const isPublicWorkspaceData = (
  obj?: { __typename?: any } | null,
): obj is PublicWorkspaceData => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPublicWorkspaceData"');
  return PublicWorkspaceData_possibleTypes.includes(obj.__typename);
};

const IndexEdge_possibleTypes: string[] = ['IndexEdge'];
export const isIndexEdge = (
  obj?: { __typename?: any } | null,
): obj is IndexEdge => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isIndexEdge"');
...
export const isIndexConnection = (
  obj?: { __typename?: any } | null,
): obj is IndexConnection => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isIndexConnection"');
  return IndexConnection_possibleTypes.includes(obj.__typename);
};

const IndexFieldEdge_possibleTypes: string[] = ['IndexFieldEdge'];
export const isIndexFieldEdge = (
  obj?: { __typename?: any } | null,
): obj is IndexFieldEdge => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isIndexFieldEdge"');
  return IndexFieldEdge_possibleTypes.includes(obj.__typename);
};

const IndexIndexFieldMetadatasConnection_possibleTypes: string[] = [
  'IndexIndexFieldMetadatasConnection',
];
export const isIndexIndexFieldMetadatasConnection = (
  obj?: { __typename?: any } | null,
): obj is IndexIndexFieldMetadatasConnection => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isIndexIndexFieldMetadatasConnection"',
    );
  return IndexIndexFieldMetadatasConnection_possibleTypes.includes(
    obj.__typename,
  );
};
...
export const isObjectEdge = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isObjectEdge"');
  return ObjectEdge_possibleTypes.includes(obj.__typename);
};

const IndexObjectMetadataConnection_possibleTypes: string[] = [
  'IndexObjectMetadataConnection',
];
export const isIndexObjectMetadataConnection = (
  obj?: { __typename?: any } | null,
): obj is IndexObjectMetadataConnection => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isIndexObjectMetadataConnection"',
    );
...
export const isObjectRecordCount = (
  obj?: { __typename?: any } | null,
): obj is ObjectRecordCount => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isObjectRecordCount"');
...
export const isObjectConnection = (
  obj?: { __typename?: any } | null,
): obj is ObjectConnection => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isObjectConnection"');
  return ObjectConnection_possibleTypes.includes(obj.__typename);
};

const ObjectIndexMetadatasConnection_possibleTypes: string[] = [
  'ObjectIndexMetadatasConnection',
];
export const isObjectIndexMetadatasConnection = (
  obj?: { __typename?: any } | null,
): obj is ObjectIndexMetadatasConnection => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isObjectIndexMetadatasConnection"',
    );
...
export const isFieldEdge = (
  obj?: { __typename?: any } | null,
): obj is FieldEdge => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFieldEdge"');
  return FieldEdge_possibleTypes.includes(obj.__typename);
};

const ObjectFieldsConnection_possibleTypes: string[] = [
  'ObjectFieldsConnection',
];
export const isObjectFieldsConnection = (
  obj?: { __typename?: any } | null,
): obj is ObjectFieldsConnection => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isObjectFieldsConnection"');
  return ObjectFieldsConnection_possibleTypes.includes(obj.__typename);
};

const UpsertRowLevelPermissionPredicatesResult_possibleTypes: string[] = [
  'UpsertRowLevelPermissionPredicatesResult',
];
export const isUpsertRowLevelPermissionPredicatesResult = (
  obj?: { __typename?: any } | null,
): obj is UpsertRowLevelPermissionPredicatesResult => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isUpsertRowLevelPermissionPredicatesResult"',
    );
  return UpsertRowLevelPermissionPredicatesResult_possibleTypes.includes(
    obj.__typename,
  );
};

const VersionDistributionEntry_possibleTypes: string[] = [
  'VersionDistributionEntry',
];
export const isVersionDistributionEntry = (
  obj?: { __typename?: any } | null,
): obj is VersionDistributionEntry => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isVersionDistributionEntry"');
  return VersionDistributionEntry_possibleTypes.includes(obj.__typename);
};

const ApplicationRegistrationStats_possibleTypes: string[] = [
  'ApplicationRegistrationStats',
];
export const isApplicationRegistrationStats = (
  obj?: { __typename?: any } | null,
): obj is ApplicationRegistrationStats => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationRegistrationStats"',
    );
  return ApplicationRegistrationStats_possibleTypes.includes(obj.__typename);
};

const CreateApplicationRegistration_possibleTypes: string[] = [
  'CreateApplicationRegistration',
];
export const isCreateApplicationRegistration = (
  obj?: { __typename?: any } | null,
): obj is CreateApplicationRegistration => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isCreateApplicationRegistration"',
    );
  return CreateApplicationRegistration_possibleTypes.includes(obj.__typename);
};

const PublicApplicationRegistration_possibleTypes: string[] = [
  'PublicApplicationRegistration',
];
export const isPublicApplicationRegistration = (
  obj?: { __typename?: any } | null,
): obj is PublicApplicationRegistration => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isPublicApplicationRegistration"',
    );
...
export const isRotateClientSecret = (
  obj?: { __typename?: any } | null,
): obj is RotateClientSecret => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRotateClientSecret"');
...
export const isWorkspaceNameAndId = (
  obj?: { __typename?: any } | null,
): obj is WorkspaceNameAndId => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkspaceNameAndId"');
...
export const isFindAvailableSSOIDP = (
  obj?: { __typename?: any } | null,
): obj is FindAvailableSSOIDP => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFindAvailableSSOIDP"');
  return FindAvailableSSOIDP_possibleTypes.includes(obj.__typename);
};

const SetupSso_possibleTypes: string[] = ['SetupSso'];
export const isSetupSso = (
  obj?: { __typename?: any } | null,
): obj is SetupSso => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSetupSso"');
  return SetupSso_possibleTypes.includes(obj.__typename);
};

const DeleteTwoFactorAuthenticationMethod_possibleTypes: string[] = [
  'DeleteTwoFactorAuthenticationMethod',
];
export const isDeleteTwoFactorAuthenticationMethod = (
  obj?: { __typename?: any } | null,
): obj is DeleteTwoFactorAuthenticationMethod => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isDeleteTwoFactorAuthenticationMethod"',
    );
  return DeleteTwoFactorAuthenticationMethod_possibleTypes.includes(
    obj.__typename,
  );
};

const InitiateTwoFactorAuthenticationProvisioning_possibleTypes: string[] = [
  'InitiateTwoFactorAuthenticationProvisioning',
];
export const isInitiateTwoFactorAuthenticationProvisioning = (
  obj?: { __typename?: any } | null,
): obj is InitiateTwoFactorAuthenticationProvisioning => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isInitiateTwoFactorAuthenticationProvisioning"',
    );
  return InitiateTwoFactorAuthenticationProvisioning_possibleTypes.includes(
    obj.__typename,
  );
};

const VerifyTwoFactorAuthenticationMethod_possibleTypes: string[] = [
  'VerifyTwoFactorAuthenticationMethod',
];
export const isVerifyTwoFactorAuthenticationMethod = (
  obj?: { __typename?: any } | null,
): obj is VerifyTwoFactorAuthenticationMethod => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isVerifyTwoFactorAuthenticationMethod"',
    );
  return VerifyTwoFactorAuthenticationMethod_possibleTypes.includes(
    obj.__typename,
  );
};
...
export const isAuthorizeApp = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAuthorizeApp"');
...
export const isAuthToken = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAuthToken"');
  return AuthToken_possibleTypes.includes(obj.__typename);
};

const AuthTokenPair_possibleTypes: string[] = ['AuthTokenPair'];
export const isAuthTokenPair = (
  obj?: { __typename?: any } | null,
): obj is AuthTokenPair => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAuthTokenPair"');
  return AuthTokenPair_possibleTypes.includes(obj.__typename);
};

const AvailableWorkspacesAndAccessTokens_possibleTypes: string[] = [
  'AvailableWorkspacesAndAccessTokens',
];
export const isAvailableWorkspacesAndAccessTokens = (
  obj?: { __typename?: any } | null,
): obj is AvailableWorkspacesAndAccessTokens => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isAvailableWorkspacesAndAccessTokens"',
    );
  return AvailableWorkspacesAndAccessTokens_possibleTypes.includes(
    obj.__typename,
  );
};

const EmailPasswordResetLink_possibleTypes: string[] = [
  'EmailPasswordResetLink',
];
export const isEmailPasswordResetLink = (
  obj?: { __typename?: any } | null,
): obj is EmailPasswordResetLink => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEmailPasswordResetLink"');
  return EmailPasswordResetLink_possibleTypes.includes(obj.__typename);
};

const GetAuthorizationUrlForSSO_possibleTypes: string[] = [
  'GetAuthorizationUrlForSSO',
];
export const isGetAuthorizationUrlForSSO = (
  obj?: { __typename?: any } | null,
): obj is GetAuthorizationUrlForSSO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isGetAuthorizationUrlForSSO"');
...
export const isInvalidatePassword = (
  obj?: { __typename?: any } | null,
): obj is InvalidatePassword => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isInvalidatePassword"');
...
export const isWorkspaceUrlsAndId = (
  obj?: { __typename?: any } | null,
): obj is WorkspaceUrlsAndId => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkspaceUrlsAndId"');
...
export const isTransientToken = (
  obj?: { __typename?: any } | null,
): obj is TransientToken => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTransientToken"');
  return TransientToken_possibleTypes.includes(obj.__typename);
};

const ValidatePasswordResetToken_possibleTypes: string[] = [
  'ValidatePasswordResetToken',
];
export const isValidatePasswordResetToken = (
  obj?: { __typename?: any } | null,
): obj is ValidatePasswordResetToken => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isValidatePasswordResetToken"');
  return ValidatePasswordResetToken_possibleTypes.includes(obj.__typename);
};

const VerifyEmailAndGetLoginToken_possibleTypes: string[] = [
  'VerifyEmailAndGetLoginToken',
];
export const isVerifyEmailAndGetLoginToken = (
  obj?: { __typename?: any } | null,
): obj is VerifyEmailAndGetLoginToken => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isVerifyEmailAndGetLoginToken"');
...
export const isApiKeyToken = (
  obj?: { __typename?: any } | null,
): obj is ApiKeyToken => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApiKeyToken"');
...
export const isAuthTokens = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAuthTokens"');
...
export const isLoginToken = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isLoginToken"');
  return LoginToken_possibleTypes.includes(obj.__typename);
};

const CheckUserExist_possibleTypes: string[] = ['CheckUserExist'];
export const isCheckUserExist = (
  obj?: { __typename?: any } | null,
): obj is CheckUserExist => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCheckUserExist"');
  return CheckUserExist_possibleTypes.includes(obj.__typename);
};

const WorkspaceInviteHashValid_possibleTypes: string[] = [
  'WorkspaceInviteHashValid',
];
export const isWorkspaceInviteHashValid = (
  obj?: { __typename?: any } | null,
): obj is WorkspaceInviteHashValid => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkspaceInviteHashValid"');
...
export const isRecordIdentifier = (
  obj?: { __typename?: any } | null,
): obj is RecordIdentifier => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRecordIdentifier"');
...
export const isNavigationMenuItem = (
  obj?: { __typename?: any } | null,
): obj is NavigationMenuItem => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isNavigationMenuItem"');
  return NavigationMenuItem_possibleTypes.includes(obj.__typename);
};

const ObjectRecordEventProperties_possibleTypes: string[] = [
  'ObjectRecordEventProperties',
];
export const isObjectRecordEventProperties = (
  obj?: { __typename?: any } | null,
): obj is ObjectRecordEventProperties => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isObjectRecordEventProperties"');
...
export const isMetadataEvent = (
  obj?: { __typename?: any } | null,
): obj is MetadataEvent => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMetadataEvent"');
  return MetadataEvent_possibleTypes.includes(obj.__typename);
};

const ObjectRecordEvent_possibleTypes: string[] = ['ObjectRecordEvent'];
export const isObjectRecordEvent = (
  obj?: { __typename?: any } | null,
): obj is ObjectRecordEvent => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isObjectRecordEvent"');
  return ObjectRecordEvent_possibleTypes.includes(obj.__typename);
};

const ObjectRecordEventWithQueryIds_possibleTypes: string[] = [
  'ObjectRecordEventWithQueryIds',
];
export const isObjectRecordEventWithQueryIds = (
  obj?: { __typename?: any } | null,
): obj is ObjectRecordEventWithQueryIds => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isObjectRecordEventWithQueryIds"',
    );
...
export const isEventSubscription = (
  obj?: { __typename?: any } | null,
): obj is EventSubscription => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEventSubscription"');
  return EventSubscription_possibleTypes.includes(obj.__typename);
};

const LogicFunctionExecutionResult_possibleTypes: string[] = [
  'LogicFunctionExecutionResult',
];
export const isLogicFunctionExecutionResult = (
  obj?: { __typename?: any } | null,
): obj is LogicFunctionExecutionResult => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isLogicFunctionExecutionResult"',
    );
...
export const isLogicFunctionLogs = (
  obj?: { __typename?: any } | null,
): obj is LogicFunctionLogs => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isLogicFunctionLogs"');
  return LogicFunctionLogs_possibleTypes.includes(obj.__typename);
};

const ToolIndexEntry_possibleTypes: string[] = ['ToolIndexEntry'];
export const isToolIndexEntry = (
  obj?: { __typename?: any } | null,
): obj is ToolIndexEntry => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isToolIndexEntry"');
  return ToolIndexEntry_possibleTypes.includes(obj.__typename);
};

const AgentMessagePart_possibleTypes: string[] = ['AgentMessagePart'];
export const isAgentMessagePart = (
  obj?: { __typename?: any } | null,
): obj is AgentMessagePart => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAgentMessagePart"');
...
export const isApplicationTokenPair = (
  obj?: { __typename?: any } | null,
): obj is ApplicationTokenPair => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApplicationTokenPair"');
...
export const isFrontComponent = (
  obj?: { __typename?: any } | null,
): obj is FrontComponent => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFrontComponent"');
  return FrontComponent_possibleTypes.includes(obj.__typename);
};

const CommandMenuItem_possibleTypes: string[] = ['CommandMenuItem'];
export const isCommandMenuItem = (
  obj?: { __typename?: any } | null,
): obj is CommandMenuItem => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCommandMenuItem"');
  return CommandMenuItem_possibleTypes.includes(obj.__typename);
};

const AgentChatThread_possibleTypes: string[] = ['AgentChatThread'];
export const isAgentChatThread = (
  obj?: { __typename?: any } | null,
): obj is AgentChatThread => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAgentChatThread"');
...
export const isAgentMessage = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAgentMessage"');
...
export const isAISystemPromptSection = (
  obj?: { __typename?: any } | null,
): obj is AISystemPromptSection => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAISystemPromptSection"');
...
export const isAISystemPromptPreview = (
  obj?: { __typename?: any } | null,
): obj is AISystemPromptPreview => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAISystemPromptPreview"');
...
export const isAgentChatThreadEdge = (
  obj?: { __typename?: any } | null,
): obj is AgentChatThreadEdge => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAgentChatThreadEdge"');
  return AgentChatThreadEdge_possibleTypes.includes(obj.__typename);
};

const AgentChatThreadConnection_possibleTypes: string[] = [
  'AgentChatThreadConnection',
];
export const isAgentChatThreadConnection = (
  obj?: { __typename?: any } | null,
): obj is AgentChatThreadConnection => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAgentChatThreadConnection"');
...
export const isAgentTurnEvaluation = (
  obj?: { __typename?: any } | null,
): obj is AgentTurnEvaluation => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAgentTurnEvaluation"');
  return AgentTurnEvaluation_possibleTypes.includes(obj.__typename);
};

const AgentTurn_possibleTypes: string[] = ['AgentTurn'];
export const isAgentTurn = (
  obj?: { __typename?: any } | null,
): obj is AgentTurn => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAgentTurn"');
  return AgentTurn_possibleTypes.includes(obj.__typename);
};

const CalendarChannel_possibleTypes: string[] = ['CalendarChannel'];
export const isCalendarChannel = (
  obj?: { __typename?: any } | null,
): obj is CalendarChannel => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCalendarChannel"');
...
export const isConnectedAccountDTO = (
  obj?: { __typename?: any } | null,
): obj is ConnectedAccountDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isConnectedAccountDTO"');
  return ConnectedAccountDTO_possibleTypes.includes(obj.__typename);
};

const MessageChannel_possibleTypes: string[] = ['MessageChannel'];
export const isMessageChannel = (
  obj?: { __typename?: any } | null,
): obj is MessageChannel => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMessageChannel"');
  return MessageChannel_possibleTypes.includes(obj.__typename);
};

const MessageFolder_possibleTypes: string[] = ['MessageFolder'];
export const isMessageFolder = (
  obj?: { __typename?: any } | null,
): obj is MessageFolder => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMessageFolder"');
  return MessageFolder_possibleTypes.includes(obj.__typename);
};

const CollectionHash_possibleTypes: string[] = ['CollectionHash'];
export const isCollectionHash = (
  obj?: { __typename?: any } | null,
): obj is CollectionHash => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCollectionHash"');
...
export const isMinimalObjectMetadata = (
  obj?: { __typename?: any } | null,
): obj is MinimalObjectMetadata => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMinimalObjectMetadata"');
  return MinimalObjectMetadata_possibleTypes.includes(obj.__typename);
};

const MinimalView_possibleTypes: string[] = ['MinimalView'];
export const isMinimalView = (
  obj?: { __typename?: any } | null,
): obj is MinimalView => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMinimalView"');
  return MinimalView_possibleTypes.includes(obj.__typename);
};

const MinimalMetadata_possibleTypes: string[] = ['MinimalMetadata'];
export const isMinimalMetadata = (
  obj?: { __typename?: any } | null,
): obj is MinimalMetadata => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMinimalMetadata"');
...
export const isBillingTrialPeriod = (
  obj?: { __typename?: any } | null,
): obj is BillingTrialPeriod => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingTrialPeriod"');
  return BillingTrialPeriod_possibleTypes.includes(obj.__typename);
};

const NativeModelCapabilities_possibleTypes: string[] = [
  'NativeModelCapabilities',
];
export const isNativeModelCapabilities = (
  obj?: { __typename?: any } | null,
): obj is NativeModelCapabilities => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isNativeModelCapabilities"');
...
export const isClientAIModelConfig = (
  obj?: { __typename?: any } | null,
): obj is ClientAIModelConfig => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isClientAIModelConfig"');
...
export const isAdminAIModelConfig = (
  obj?: { __typename?: any } | null,
): obj is AdminAIModelConfig => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAdminAIModelConfig"');
  return AdminAIModelConfig_possibleTypes.includes(obj.__typename);
};

const AdminAIModels_possibleTypes: string[] = ['AdminAIModels'];
export const isAdminAIModels = (
  obj?: { __typename?: any } | null,
): obj is AdminAIModels => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAdminAIModels"');
...
export const isApiConfig = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApiConfig"');
  return ApiConfig_possibleTypes.includes(obj.__typename);
};

const PublicFeatureFlagMetadata_possibleTypes: string[] = [
  'PublicFeatureFlagMetadata',
];
export const isPublicFeatureFlagMetadata = (
  obj?: { __typename?: any } | null,
): obj is PublicFeatureFlagMetadata => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPublicFeatureFlagMetadata"');
...
export const isPublicFeatureFlag = (
  obj?: { __typename?: any } | null,
): obj is PublicFeatureFlag => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPublicFeatureFlag"');
...
export const isClientConfig = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isClientConfig"');
  return ClientConfig_possibleTypes.includes(obj.__typename);
};

const ConfigVariable_possibleTypes: string[] = ['ConfigVariable'];
export const isConfigVariable = (
  obj?: { __typename?: any } | null,
): obj is ConfigVariable => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isConfigVariable"');
  return ConfigVariable_possibleTypes.includes(obj.__typename);
};

const ConfigVariablesGroupData_possibleTypes: string[] = [
  'ConfigVariablesGroupData',
];
export const isConfigVariablesGroupData = (
  obj?: { __typename?: any } | null,
): obj is ConfigVariablesGroupData => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isConfigVariablesGroupData"');
...
export const isConfigVariables = (
  obj?: { __typename?: any } | null,
): obj is ConfigVariables => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isConfigVariables"');
...
export const isJobOperationResult = (
  obj?: { __typename?: any } | null,
): obj is JobOperationResult => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isJobOperationResult"');
...
export const isDeleteJobsResponse = (
  obj?: { __typename?: any } | null,
): obj is DeleteJobsResponse => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isDeleteJobsResponse"');
  return DeleteJobsResponse_possibleTypes.includes(obj.__typename);
};

const QueueJob_possibleTypes: string[] = ['QueueJob'];
export const isQueueJob = (
  obj?: { __typename?: any } | null,
): obj is QueueJob => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isQueueJob"');
...
export const isQueueRetentionConfig = (
  obj?: { __typename?: any } | null,
): obj is QueueRetentionConfig => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isQueueRetentionConfig"');
...
export const isQueueJobsResponse = (
  obj?: { __typename?: any } | null,
): obj is QueueJobsResponse => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isQueueJobsResponse"');
...
export const isRetryJobsResponse = (
  obj?: { __typename?: any } | null,
): obj is RetryJobsResponse => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRetryJobsResponse"');
...
export const isSystemHealthService = (
  obj?: { __typename?: any } | null,
): obj is SystemHealthService => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSystemHealthService"');
  return SystemHealthService_possibleTypes.includes(obj.__typename);
};

const SystemHealth_possibleTypes: string[] = ['SystemHealth'];
export const isSystemHealth = (
  obj?: { __typename?: any } | null,
): obj is SystemHealth => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSystemHealth"');
...
export const isUserInfo = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUserInfo"');
  return UserInfo_possibleTypes.includes(obj.__typename);
};

const WorkspaceInfo_possibleTypes: string[] = ['WorkspaceInfo'];
export const isWorkspaceInfo = (
  obj?: { __typename?: any } | null,
): obj is WorkspaceInfo => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkspaceInfo"');
  return WorkspaceInfo_possibleTypes.includes(obj.__typename);
};

const UserLookup_possibleTypes: string[] = ['UserLookup'];
export const isUserLookup = (
  obj?: { __typename?: any } | null,
): obj is UserLookup => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUserLookup"');
...
const AdminPanelWorkerQueueHealth_possibleTypes: string[] = [
  'AdminPanelWorkerQueueHealth',
];
export const isAdminPanelWorkerQueueHealth = (
  obj?: { __typename?: any } | null,
): obj is AdminPanelWorkerQueueHealth => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAdminPanelWorkerQueueHealth"');
  return AdminPanelWorkerQueueHealth_possibleTypes.includes(obj.__typename);
};

const AdminPanelHealthServiceData_possibleTypes: string[] = [
  'AdminPanelHealthServiceData',
];
export const isAdminPanelHealthServiceData = (
  obj?: { __typename?: any } | null,
): obj is AdminPanelHealthServiceData => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAdminPanelHealthServiceData"');
  return AdminPanelHealthServiceData_possibleTypes.includes(obj.__typename);
};

const ModelsDevModelSuggestion_possibleTypes: string[] = [
  'ModelsDevModelSuggestion',
];
export const isModelsDevModelSuggestion = (
  obj?: { __typename?: any } | null,
): obj is ModelsDevModelSuggestion => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isModelsDevModelSuggestion"');
  return ModelsDevModelSuggestion_possibleTypes.includes(obj.__typename);
};

const ModelsDevProviderSuggestion_possibleTypes: string[] = [
  'ModelsDevProviderSuggestion',
];
export const isModelsDevProviderSuggestion = (
  obj?: { __typename?: any } | null,
): obj is ModelsDevProviderSuggestion => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isModelsDevProviderSuggestion"');
...
export const isQueueMetricsDataPoint = (
  obj?: { __typename?: any } | null,
): obj is QueueMetricsDataPoint => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isQueueMetricsDataPoint"');
...
export const isQueueMetricsSeries = (
  obj?: { __typename?: any } | null,
): obj is QueueMetricsSeries => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isQueueMetricsSeries"');
...
export const isWorkerQueueMetrics = (
  obj?: { __typename?: any } | null,
): obj is WorkerQueueMetrics => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkerQueueMetrics"');
...
export const isQueueMetricsData = (
  obj?: { __typename?: any } | null,
): obj is QueueMetricsData => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isQueueMetricsData"');
...
export const isImpersonate = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isImpersonate"');
  return Impersonate_possibleTypes.includes(obj.__typename);
};

const DevelopmentApplication_possibleTypes: string[] = [
  'DevelopmentApplication',
];
export const isDevelopmentApplication = (
  obj?: { __typename?: any } | null,
): obj is DevelopmentApplication => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isDevelopmentApplication"');
...
export const isWorkspaceMigration = (
  obj?: { __typename?: any } | null,
): obj is WorkspaceMigration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkspaceMigration"');
...
export const isMarketplaceAppField = (
  obj?: { __typename?: any } | null,
): obj is MarketplaceAppField => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMarketplaceAppField"');
...
export const isMarketplaceAppObject = (
  obj?: { __typename?: any } | null,
): obj is MarketplaceAppObject => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMarketplaceAppObject"');
  return MarketplaceAppObject_possibleTypes.includes(obj.__typename);
};

const MarketplaceAppLogicFunction_possibleTypes: string[] = [
  'MarketplaceAppLogicFunction',
];
export const isMarketplaceAppLogicFunction = (
  obj?: { __typename?: any } | null,
): obj is MarketplaceAppLogicFunction => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMarketplaceAppLogicFunction"');
  return MarketplaceAppLogicFunction_possibleTypes.includes(obj.__typename);
};

const MarketplaceAppFrontComponent_possibleTypes: string[] = [
  'MarketplaceAppFrontComponent',
];
export const isMarketplaceAppFrontComponent = (
  obj?: { __typename?: any } | null,
): obj is MarketplaceAppFrontComponent => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isMarketplaceAppFrontComponent"',
    );
  return MarketplaceAppFrontComponent_possibleTypes.includes(obj.__typename);
};

const MarketplaceAppRoleObjectPermission_possibleTypes: string[] = [
  'MarketplaceAppRoleObjectPermission',
];
export const isMarketplaceAppRoleObjectPermission = (
  obj?: { __typename?: any } | null,
): obj is MarketplaceAppRoleObjectPermission => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isMarketplaceAppRoleObjectPermission"',
    );
  return MarketplaceAppRoleObjectPermission_possibleTypes.includes(
    obj.__typename,
  );
};

const MarketplaceAppRoleFieldPermission_possibleTypes: string[] = [
  'MarketplaceAppRoleFieldPermission',
];
export const isMarketplaceAppRoleFieldPermission = (
  obj?: { __typename?: any } | null,
): obj is MarketplaceAppRoleFieldPermission => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isMarketplaceAppRoleFieldPermission"',
    );
  return MarketplaceAppRoleFieldPermission_possibleTypes.includes(
    obj.__typename,
  );
};

const MarketplaceAppDefaultRole_possibleTypes: string[] = [
  'MarketplaceAppDefaultRole',
];
export const isMarketplaceAppDefaultRole = (
  obj?: { __typename?: any } | null,
): obj is MarketplaceAppDefaultRole => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMarketplaceAppDefaultRole"');
...
export const isMarketplaceApp = (
  obj?: { __typename?: any } | null,
): obj is MarketplaceApp => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMarketplaceApp"');
...
export const isUsageBreakdownItem = (
  obj?: { __typename?: any } | null,
): obj is UsageBreakdownItem => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUsageBreakdownItem"');
...
export const isUsageTimeSeries = (
  obj?: { __typename?: any } | null,
): obj is UsageTimeSeries => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUsageTimeSeries"');
  return UsageTimeSeries_possibleTypes.includes(obj.__typename);
};

const UsageUserDaily_possibleTypes: string[] = ['UsageUserDaily'];
export const isUsageUserDaily = (
  obj?: { __typename?: any } | null,
): obj is UsageUserDaily => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUsageUserDaily"');
  return UsageUserDaily_possibleTypes.includes(obj.__typename);
};

const UsageAnalytics_possibleTypes: string[] = ['UsageAnalytics'];
export const isUsageAnalytics = (
  obj?: { __typename?: any } | null,
): obj is UsageAnalytics => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUsageAnalytics"');
...
export const isPublicDomain = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPublicDomain"');
...
export const isVerificationRecord = (
  obj?: { __typename?: any } | null,
): obj is VerificationRecord => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isVerificationRecord"');
  return VerificationRecord_possibleTypes.includes(obj.__typename);
};

const EmailingDomain_possibleTypes: string[] = ['EmailingDomain'];
export const isEmailingDomain = (
  obj?: { __typename?: any } | null,
): obj is EmailingDomain => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEmailingDomain"');
...
export const isAutocompleteResult = (
  obj?: { __typename?: any } | null,
): obj is AutocompleteResult => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAutocompleteResult"');
...
export const isPlaceDetailsResult = (
  obj?: { __typename?: any } | null,
): obj is PlaceDetailsResult => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPlaceDetailsResult"');
  return PlaceDetailsResult_possibleTypes.includes(obj.__typename);
};

const ConnectionParametersOutput_possibleTypes: string[] = [
  'ConnectionParametersOutput',
];
export const isConnectionParametersOutput = (
  obj?: { __typename?: any } | null,
): obj is ConnectionParametersOutput => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isConnectionParametersOutput"');
  return ConnectionParametersOutput_possibleTypes.includes(obj.__typename);
};

const ImapSmtpCaldavConnectionParameters_possibleTypes: string[] = [
  'ImapSmtpCaldavConnectionParameters',
];
export const isImapSmtpCaldavConnectionParameters = (
  obj?: { __typename?: any } | null,
): obj is ImapSmtpCaldavConnectionParameters => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isImapSmtpCaldavConnectionParameters"',
    );
  return ImapSmtpCaldavConnectionParameters_possibleTypes.includes(
    obj.__typename,
  );
};

const ConnectedImapSmtpCaldavAccount_possibleTypes: string[] = [
  'ConnectedImapSmtpCaldavAccount',
];
export const isConnectedImapSmtpCaldavAccount = (
  obj?: { __typename?: any } | null,
): obj is ConnectedImapSmtpCaldavAccount => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isConnectedImapSmtpCaldavAccount"',
    );
  return ConnectedImapSmtpCaldavAccount_possibleTypes.includes(obj.__typename);
};

const ImapSmtpCaldavConnectionSuccess_possibleTypes: string[] = [
  'ImapSmtpCaldavConnectionSuccess',
];
export const isImapSmtpCaldavConnectionSuccess = (
  obj?: { __typename?: any } | null,
): obj is ImapSmtpCaldavConnectionSuccess => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isImapSmtpCaldavConnectionSuccess"',
    );
...
export const isPostgresCredentials = (
  obj?: { __typename?: any } | null,
): obj is PostgresCredentials => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPostgresCredentials"');
...
export const isChannelSyncSuccess = (
  obj?: { __typename?: any } | null,
): obj is ChannelSyncSuccess => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isChannelSyncSuccess"');
  return ChannelSyncSuccess_possibleTypes.includes(obj.__typename);
};

const BarChartSeries_possibleTypes: string[] = ['BarChartSeries'];
export const isBarChartSeries = (
  obj?: { __typename?: any } | null,
): obj is BarChartSeries => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBarChartSeries"');
  return BarChartSeries_possibleTypes.includes(obj.__typename);
};

const BarChartData_possibleTypes: string[] = ['BarChartData'];
export const isBarChartData = (
  obj?: { __typename?: any } | null,
): obj is BarChartData => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBarChartData"');
...
export const isLineChartDataPoint = (
  obj?: { __typename?: any } | null,
): obj is LineChartDataPoint => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isLineChartDataPoint"');
...
export const isLineChartSeries = (
  obj?: { __typename?: any } | null,
): obj is LineChartSeries => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isLineChartSeries"');
  return LineChartSeries_possibleTypes.includes(obj.__typename);
};

const LineChartData_possibleTypes: string[] = ['LineChartData'];
export const isLineChartData = (
  obj?: { __typename?: any } | null,
): obj is LineChartData => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isLineChartData"');
  return LineChartData_possibleTypes.includes(obj.__typename);
};

const PieChartDataItem_possibleTypes: string[] = ['PieChartDataItem'];
export const isPieChartDataItem = (
  obj?: { __typename?: any } | null,
): obj is PieChartDataItem => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPieChartDataItem"');
  return PieChartDataItem_possibleTypes.includes(obj.__typename);
};

const PieChartData_possibleTypes: string[] = ['PieChartData'];
export const isPieChartData = (
  obj?: { __typename?: any } | null,
): obj is PieChartData => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPieChartData"');
...
export const isDuplicatedDashboard = (
  obj?: { __typename?: any } | null,
): obj is DuplicatedDashboard => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isDuplicatedDashboard"');
  return DuplicatedDashboard_possibleTypes.includes(obj.__typename);
};

const EventLogRecord_possibleTypes: string[] = ['EventLogRecord'];
export const isEventLogRecord = (
  obj?: { __typename?: any } | null,
): obj is EventLogRecord => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEventLogRecord"');
  return EventLogRecord_possibleTypes.includes(obj.__typename);
};

const EventLogPageInfo_possibleTypes: string[] = ['EventLogPageInfo'];
export const isEventLogPageInfo = (
  obj?: { __typename?: any } | null,
): obj is EventLogPageInfo => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEventLogPageInfo"');
...
export const isEventLogQueryResult = (
  obj?: { __typename?: any } | null,
): obj is EventLogQueryResult => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEventLogQueryResult"');
...
export const enumFeatureFlagKey = {
  ...
  IS_RECORD_PAGE_LAYOUT_EDITING_ENABLED:
    'IS_RECORD_PAGE_LAYOUT_EDITING_ENABLED' as const,
  ...
  IS_ROW_LEVEL_PERMISSION_PREDICATES_ENABLED:
    'IS_ROW_LEVEL_PERMISSION_PREDICATES_ENABLED' as const,
  ...
  IS_DATE_TIME_WHOLE_DAY_FILTER_ENABLED:
    'IS_DATE_TIME_WHOLE_DAY_FILTER_ENABLED' as const,
  IS_NAVIGATION_MENU_ITEM_EDITING_ENABLED:
    'IS_NAVIGATION_MENU_ITEM_EDITING_ENABLED' as const,
  ...
  IS_DIRECT_GRAPHQL_EXECUTION_ENABLED:
    'IS_DIRECT_GRAPHQL_EXECUTION_ENABLED' as const,
  IS_RECORD_PAGE_LAYOUT_GLOBAL_EDITION_ENABLED:
    'IS_RECORD_PAGE_LAYOUT_GLOBAL_EDITION_ENABLED' as const,
...
export const enumCalendarChannelSyncStage = {
  ...
  CALENDAR_EVENT_LIST_FETCH_PENDING:
    'CALENDAR_EVENT_LIST_FETCH_PENDING' as const,
  CALENDAR_EVENT_LIST_FETCH_SCHEDULED:
    'CALENDAR_EVENT_LIST_FETCH_SCHEDULED' as const,
  CALENDAR_EVENT_LIST_FETCH_ONGOING:
    'CALENDAR_EVENT_LIST_FETCH_ONGOING' as const,
